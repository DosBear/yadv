...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:mpco="urn:customs.ru:Information:CustomsDocuments:MPOCommon:5.14.2" xmlns:mpf="urn:customs.ru:Information:CustomsDocuments:MPOFact:5.14.2" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.14.0">
								...
								<tr>
									<td style="border:solid 0pt">
										<span class="graph">Почтовый индекс<br/>
											<xsl:choose>
												<xsl:when test="mpco:Consignor/mpco:ExPostalCode"><xsl:value-of select="mpco:Consignor/mpco:ExPostalCode"/></xsl:when>
												<xsl:otherwise><xsl:value-of select="mpco:Consignor/RUScat_ru:SubjectAddressDetails/RUScat_ru:PostalCode"/></xsl:otherwise>
											</xsl:choose>
										</span>
									</td>
									<td style="border:solid 0pt">
							...
							<table cellspacing="6">
								<tr>
									<td style="border:solid 0pt">
										<span class="graph">Почтовый индекс<br/>
											<xsl:choose>
												<xsl:when test="mpco:Consignee/mpco:ExPostalCode"><xsl:value-of select="mpco:Consignee/mpco:ExPostalCode"/></xsl:when>
												<xsl:otherwise><xsl:value-of select="mpco:Consignee/RUScat_ru:SubjectAddressDetails/RUScat_ru:PostalCode"/></xsl:otherwise>
											</xsl:choose>
										</span>
									</td>
									<td style="border:solid 0pt">
										...
										<tr>
											<td style="padding:0pt 5pt; border: 0px; word-break: break-all;">
												<span class="graph">
													...
													<a href="{mpco:URLGood}"><xsl:value-of select="mpco:URLGood"/></a> 
												</span>
											</td>
										</tr>
									</xsl:if>
