										...
										<td>
											<table>
												<tbody>
													...
													<tr>
														<td width="15%" class="descr"> </td>
														<td width="85%" class="descr">(должность, фамилия, инициалы имени и отчества (инициал отчества указывается при наличии отчества) должностного лица таможенного органа, принявшего изменяемое решение)</td>
													</tr>
												</tbody>
											</table>
										</td>
											...
											<table>
												<tbody>
													<tr valign="top" align="center">
														...
														<td style="border: 1px solid black;">Измененные (дополненные) сведения</td>
													</tr>
