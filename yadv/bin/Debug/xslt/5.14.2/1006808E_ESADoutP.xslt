                        ...
                        <tbody>
                           ...
                           <tr>
                              <td class="graph" colspan="2" rowspan="3" style="width:{76}mm;border-bottom:solid 0.8pt #000000;" valign="top">
                                ...
                                Размеры
								<xsl:apply-templates select="catESAD_cu:GoodsGroupInformation/catESAD_cu:Dimensions"/>
                            </xsl:if>
