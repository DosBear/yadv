...
<!-- 
Письмо ФТС России от 27.09.2018 № 01-54/61519 "О направлении проекта приказа ФТС России" (Приложение 9)
					...
					<table class="w190">
						<tbody>
							...
							<tr>
								<td>
									<br/>
									Приложение <span class="value">&#160;<xsl:value-of select="asg:AdditionalName"/>&#160;</span> на <span class="value">&#160;<xsl:value-of select="asg:AdditionalSheetNumber"/>&#160;</span> листах.
								</td>
							</tr>
							<tr>
								<td>
							...
							<xsl:if test="asg:RefusalMark">
								<tr>
									<td>
										...
										<xsl:apply-templates mode="signatureMark" select="asg:RefusalMark"/>
									</td>
								</tr>
								<tr>
									<td>
