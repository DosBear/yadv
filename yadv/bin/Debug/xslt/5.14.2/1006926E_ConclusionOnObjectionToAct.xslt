...
Письмо ФТС России от 27.09.2018 № 01-54/61519 "О направлении проекта приказа ФТС России" (Приложение 28)
-->
		...
		<div class="page">
				...
				<tbody align="center" class="graphMain">
					...
					<tr>
						...
						<td width="80%" class="border_bottom">
							<span class="normal">
								<xsl:choose>
									<xsl:when test="cota:CustomsIssued/adt_cat:FullOfficeName"><xsl:value-of select="cota:CustomsIssued/adt_cat:FullOfficeName"/></xsl:when>
									<xsl:otherwise><xsl:value-of select="cota:CustomsIssued/cat_ru:OfficeName"/></xsl:otherwise>
								</xsl:choose>
							</span>
							<xsl:if test="cota:CustomsIssued/adt_cat:FullOfficeName or cota:CustomsIssued/cat_ru:OfficeName">
								<span class="normal"> (</span>
							</xsl:if>
							<span class="normal"><xsl:value-of select="cota:CustomsIssued/cat_ru:Code"/></span>
							<xsl:if test="cota:CustomsIssued/adt_cat:FullOfficeName or cota:CustomsIssued/cat_ru:OfficeName">
								<span class="normal">)</span>
							</xsl:if>
						</td>
							...
							<table>
								<tr align="center">
									...
									<td width="63%" class="border_bottom">
										...
										<xsl:if test="cota:CustomsIssued/cota:LNP">
											&#160;(<xsl:value-of select="cota:CustomsIssued/cota:LNP"/>)
										</xsl:if>		
										<br/>
									</td>
								</tr>
			...
			<table>
				<tbody align="left" class="graphMain">
					...
					<tr align="center">
						<td>
							№&#160;<u>&#160;<xsl:value-of select="cota:ConclusionNumber/adt_cat:Number"/>&#160;</u>
						</td>
					</tr>
					<tr class="delim_3"><td> </td></tr>
				</tbody>
			...
			<table>
				<tbody align="center" class="graphMain">
					<tr>
						...
						<td width="15%"> </td>
						<td width="40%" class="border_bottom"><xsl:value-of select="cota:ConclusionPlace"/></td>
					</tr>
					<tr class="graphLittle">
						<td width="45%">(дата)</td>
						<td  width="10%"> </td>
				...
				<tbody align="left" class="graphMain">
					...
					<tr>
						<td  class="border_bottom">
							<xsl:choose>
								<xsl:when test="cota:ChiefCommission"><xsl:apply-templates select="cota:ChiefCommission"/></xsl:when>
								<xsl:otherwise><xsl:apply-templates select="cota:CustomsPerson"/></xsl:otherwise>
							</xsl:choose>
						</td>
					</tr>
				</tbody>
						...
						<td>
							<table>
									<tr>
										...
										<td width="3%" >№</td>
										<td width="61%" class="border_bottom">&#160;<xsl:value-of select="cota:ObjectionNumber/adt_cat:Number"/><br/></td>
									</tr>
							</table>
						</td>
					</tr>
					...
					<tr>
						<td>
							<table>
									<tr>
										<td width="2%" >№</td>
										<td width="97%" class="border_bottom">&#160;<xsl:value-of select="cota:ActNumber/adt_cat:Number"/><br/></td>
										<td width="1%" >,</td>
									</tr>
							</table>
						</td>
			...
			<xsl:for-each select="cota:CustomsPerson">
				<br/>
				<table>
					<tbody class="graphMain">
						<tr align="center">
