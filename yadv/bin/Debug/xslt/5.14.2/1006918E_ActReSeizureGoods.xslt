						...
						<tbody>
							...
							<tr>
								<td>
									...
									<xsl:call-template name="signature">
										<xsl:with-param name="data" select="arsg:CustomActArresting/arsg:ApproverPerson"/>
