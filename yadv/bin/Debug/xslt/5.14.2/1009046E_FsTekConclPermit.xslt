...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.14.0" xmlns:fscnpr="urn:customs.ru:Information:SQDocuments:FsTekConclPermit:5.14.2">
								...
								<xsl:for-each select="fscnpr:ConslusionsDocument">
									...
									<xsl:if test="fscnpr:FileData">
										...
										<xsl:variable name="f_ex4">
											<xsl:value-of select="translate(substring(fscnpr:FileName,string-length(fscnpr:FileName)-3,4),$upper,$lower)"/>
										</xsl:variable>
										<xsl:variable name="f_ex5">
											<xsl:value-of select="translate(substring(fscnpr:FileName,string-length(fscnpr:FileName)-4,5),$upper,$lower)"/>
										</xsl:variable>
													...
													<td>
														<table width="190">
															<tbody>
																<tr>
																	<td align="center">
																		<xsl:variable name="fileName" select="fscnpr:FileName"/>
