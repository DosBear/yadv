...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:vtstek="urn:customs.ru:Information:SQDocuments:FsVtsTekLicense:5.14.2" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.14.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
							...
							<xsl:for-each select="vtstek:ConslusionsDocument">
								...
								<xsl:if test="vtstek:FileData">
									...
									<xsl:variable name="f_ex4">
										<xsl:value-of select="translate(substring(vtstek:FileName,string-length(vtstek:FileName)-3,4),$upper,$lower)"/>
									</xsl:variable>
									<xsl:variable name="f_ex5">
										<xsl:value-of select="translate(substring(vtstek:FileName,string-length(vtstek:FileName)-4,5),$upper,$lower)"/>
									</xsl:variable>
												...
												<td>
													<table width="190">
														<tbody>
															<tr>
																<td align="center">
																	<xsl:variable name="fileName" select="vtstek:FileName"/>
