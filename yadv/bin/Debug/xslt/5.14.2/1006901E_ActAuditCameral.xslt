		...
		<div class="page">
					...
					<tbody align="left" class="graphMain">
						...
						<tr>
							<td>
								<table>
										<tr>
											<td width="99%" class="border_bottom"><span class="normal">сылка на план проверок либо на соответствующее основание, предусмотренное пунктом 16 статьи 333 ТК ЕАЭС, либо частью 7 статьи 229 Федерального закона от 3 августа 2018 г. № 289-ФЗ «О таможенном регулировании в Российской Федерации и о внесении изменений в отдельные законодательные акты Российской Федерации»: 
											<xsl:apply-templates select="aac:Article"/></span></td>
							...
							<td>
								<table>
										...
										<tr class="graphLittle" align="center">
											<td width="13%" > </td>
											<td width="2%" ></td>
											<td width="45%">(плановая/внеплановая/встречная внеплановая)</td>
											<td width="2%" ></td>
											<td width="48%" > </td>
										</tr>
								</table>
			...
			<table>
				<tbody align="left" class="graphMain">
					<tr class="delim"><td> </td></tr>
					<tr>
						<td>Виды других проверенных документов и сведений:</td>
					</tr>
					<tr class="delim_3"><td> </td></tr>
					<tr>
						<td  class="border_bottom">
...
<xsl:template match="aac:SubjectInspection">
	...
	<xsl:if test="aac:SubjectInspectionText and aac:SubjectInspectionCode">;<br/></xsl:if>
	<xsl:if test="aac:SubjectInspectionText">
		<span class="normal"> 
			<xsl:value-of select="aac:SubjectInspectionText"/>
		</span>
	</xsl:if>
	<xsl:if test="(aac:SubjectInspectionText or aac:SubjectInspectionCode) and aac:Note">;<br/></xsl:if>
	<xsl:if test="aac:Note">
		<span class="normal">примечания: 
			<xsl:value-of select="aac:Note"/>
		</span>
