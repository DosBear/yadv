...
-->
	...
	<!-- с версии 5.14.2 KindDoc = 2 - Приказ ФТС России от 04.12.2018 № 1980 -->
			...
			<body>
				<div class="page">
					...
					<table>
						<tbody align="center" class="graphMain">
							<tr>
								...
								<td width="15%"> </td>
								<td width="40%" valign="bottom" class="value">
					...
					<table>
						<tbody align="left" class="graphMain">
							...
							<tr>
								<td class="graphMain">
									<xsl:choose>
										<xsl:when test="resa:KindDoc = '2'">Должностное лицо</xsl:when>
									</xsl:choose>
								</td>
							</tr>
							<tr>
							...
							<tr class="graphLittle">
								<td align="center">
									<xsl:choose>
										<xsl:when test="resa:KindDoc = '2'">(должность, фамилия, имя, отчество (отчество указывается при наличии) начальника таможенного органа либо уполномоченного им должностного лица, вынесшего постановление)</xsl:when>
										<xsl:otherwise>(должность, фамилия, имя, отчество (отчество указывается при наличии) должностного лица таможенного органа, вынесшего постановление)</xsl:otherwise>
									</xsl:choose>
								</td>
							</tr>
						</tbody>
						...
						<tbody align="left" class="graphMain">
							<xsl:choose>
								<xsl:when test="resa:KindDoc = '2'">
									...
									<tr>
										<td class="value">
											<xsl:value-of select="resa:NameFormCustomsControl"/>
										</td>
									</tr>
									<tr align="center">
					...
					<xsl:if test="resa:CustomsMark">
						...
						<table>
							<tr class="graphMain" align="center">
								<td width="36%" valign="bottom" class="value"><xsl:value-of select="resa:CustomsMark/cat_ru:PersonPost"/></td>
								<td width="7%"> </td>
