...
<xsl:stylesheet exclude-result-prefixes="ESADout_CU cat_ru catESAD_cu" version="1.0" xmlns="http://www.w3.org/1999/xhtml" xmlns:ESADout_CU="urn:customs.ru:Information:CustomsDocuments:ESADout_CU:5.14.0" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.14.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.14.0" xmlns:RUDECLcat="urn:customs.ru:RUDeclCommonAggregateTypesCust:5.14.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:goom="urn:customs.ru:Information:CustomsDocuments:GTDOutCustomsMark:5.14.0">
	...
	<xsl:template match="ESADout_CU:GoodsAutomobile">
		<tr>
			...
			<td>
				<xsl:apply-templates select="catESAD_cu:EngineVolumeQuanity"/>
			</td>
			<td>
							...
							<td class="graph" style="width:{56.3*$k}mm;background:#FFFFFF;">
								<xsl:choose>
									<xsl:when test="ESADout_CU:ESADout_CUConsigment/ESADout_CU:ESADout_CUDepartureArrivalTransport">
										<xsl:value-of select="ESADout_CU:ESADout_CUConsigment/ESADout_CU:ESADout_CUDepartureArrivalTransport/ESADout_CU:TransportMeansQuantity"/><xsl:text>:</xsl:text>
								...
								<xsl:choose>
									<xsl:when test="ESADout_CU:ESADout_CUConsigment/ESADout_CU:ESADout_CUBorderTransport">
										...
										<xsl:for-each select="ESADout_CU:ESADout_CUConsigment/ESADout_CU:ESADout_CUBorderTransport/ESADout_CU:TransportMeans">
											...
											<xsl:if test="(catESAD_cu:FirstTrailerRegId)">
												<xsl:text>/</xsl:text><xsl:value-of select="catESAD_cu:FirstTrailerRegId"/>
											</xsl:if>
											<xsl:if test="(catESAD_cu:SecondTrailerRegId)">
												<xsl:text>/</xsl:text><xsl:value-of select="catESAD_cu:SecondTrailerRegId"/>
											</xsl:if>
										</xsl:for-each>
									</xsl:when>
									<xsl:otherwise>
						...
						<table cellpadding="0" cellspacing="0" style="width:100%;">
							...
							<tr class="graph" align="center" style="vertical-align: bottom">
								...
								<td align="left" style="border-right:solid 0.8pt black; border-bottom:solid 0.8pt black;word-break: break-all;">
									<xsl:choose>
										<xsl:when test="catESAD_cu:GrossWeightQuantity">
