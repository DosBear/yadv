						...
						<tr>
							...
							<td>
								...
								<xsl:if test=".//catESAD_cu:Manufacturer">
									...
									<!--xsl:for-each select=".//catESAD_cu:Manufacturer[not(.=preceding-sibling::*)]"-->
								...
								<xsl:if test=".//catESAD_cu:TradeMark">
									...
									<!--xsl:for-each select=".//catESAD_cu:TradeMark[not(.=preceding-sibling::*)]"-->
