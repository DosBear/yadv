							...
							<xsl:when test="(do2r:GoodsShipment/do2r:MPOSign=0) or (do2r:GoodsShipment/do2r:MPOSign='f') or (do2r:GoodsShipment/do2r:MPOSign='false')">
								<table style="width:250mm">
									<tr>
										...
										<td class="bordered" align="center" colspan="11" style="width:155mm">
											<b>Приход</b>
										</td>
										<td class="bordered" align="center" colspan="6" style="width:85mm">
											<b>Расход</b>
										</td>
									...
									<tr>
										...
										<!--3-->
										<td class="bordered" style="width:8mm">Номер отчета по форме ДО1</td>
										<!--4-->
										<td class="bordered" style="width:10mm">Поряд-ковый номер товаров в отч-ете по форме ДО1мв</td>
										<!--5-->
										...
										<!--12-->
										<td class="bordered" style="width:12mm">Дата оконча-ния вре-менного хранения</td>
										<!--13-->
										...
										<td class="bordered" style="width:17mm">Стоимость товара в валюте указанной в транспортных или коммерческих документах</td>
										<!--17-->
										<td class="bordered" style="width:17mm">Вид,дата и номер документа, по которому разрешена выдача то-варов со склада</td>
										<!--18-->
							...
							<xsl:when test="(do2r:GoodsShipment/do2r:MPOSign=1) or (do2r:GoodsShipment/do2r:MPOSign='t') or (do2r:GoodsShipment/do2r:MPOSign='true')">
								<table style="width:250mm">
									...
									<tr>
										...
										<td class="bordered" style="width:11mm">Дата и время поме-щения на склад</td>
										<!--3-->
										<td class="bordered" style="width:8mm">Номер отчета по форме ДО1мв</td>
										<!--4-->
										<td class="bordered" style="width:10mm">Поряд-ковый номер МПО в отч-ете по форме ДО1мв</td>
										<!--5-->
				...
				<xsl:choose>
					<xsl:when test="(do2r:GoodsShipment/do2r:MPOSign=0) or (do2r:GoodsShipment/do2r:MPOSign='f') or (do2r:GoodsShipment/do2r:MPOSign='false')">
						<table width="250mm">
							<tr class="bordered">
								<td>  </td>
								<td align="center" class="bordered" colspan="12">
									<b>Приход</b>
								</td>
								<td class="bordered" align="center" colspan="5">
									<b>Расход</b>
					...
					<xsl:when test="(do2r:GoodsShipment/do2r:MPOSign=1) or (do2r:GoodsShipment/do2r:MPOSign='t') or (do2r:GoodsShipment/do2r:MPOSign='true')">
						<table width="250mm">
							...
							<tr>
								...
								<td class="bordered" style="width:11mm">Дата и время поме-щения на склад</td>
								<!--3-->
								<td style="width:8mm" class="bordered">Номер отчета по форме ДО1мв</td>
								<!--4-->
								<td class="bordered" style="width:10mm">Поряд-ковый номер МПО в отч-ете по форме ДО1мв</td>
								<!--5-->
								<td class="bordered" style="width:18mm">Номер МПО</td>
