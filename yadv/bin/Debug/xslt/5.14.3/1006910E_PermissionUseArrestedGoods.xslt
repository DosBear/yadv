			...
			<body>
				<div class="page">
					...
					<table>
						<tbody align="left" class="graphMain">
							<tr>
								<td><span class="normal">рассмотрев заявление</span></td>
							</tr>
							<tr>
								<td class="border_bottom"><xsl:apply-templates select="puag:Applicant" mode="only_name"/>;&#160;<xsl:apply-templates select="puag:StatementNumber"/><br/></td>
							</tr>
							<tr class="graphLittle">
							...
							<tr>
								<td align="center"><span class="normal">РЕШИЛ:</span></td>
							</tr>
							<tr>
								<td class="delim_3"><br/></td>
							</tr>		
							<tr>
								<td><span class="normal">Разрешить лицу</span></td>
							</tr>
							<tr>
								<td class="delim_3"><br/></td>
							</tr>	
							<tr>
								<td class="border_bottom"><xsl:apply-templates select="puag:PermissionPerson"/><br/></td>
							</tr>
							<tr>
								<td class="delim_3"><br/></td>
							</tr>	
							<tr>
								<td><span class="normal">пользоваться товарами</span></td>
							</tr>
							<tr>
								<td class="delim_3"><br/></td>
							</tr>
							...
							<tr>
								<td><span class="normal"> на которые наложен арест на основании постановления</span></td>
							</tr>
							<tr>
								<td class="delim_3"><br/></td>
							</tr>	
					...
					<xsl:for-each select="puag:SecondExempReceived">
						...
						<table>
							<tbody align="left" class="graphMain">
								<tr>
									<td><span class="normal">	Копию разрешения на пользование товарами получил:</span></td>
								</tr>
							<tr>
								<td class="delim_3"><br/></td>
							</tr>
								<tr>
									<td><span class="normal">Лицо, обладающее полномочиями в отношении товаров (его представитель):</span></td>
								</tr>
							<tr>
								<td class="delim_3"><br/></td>
							</tr>
