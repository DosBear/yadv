               ...
               <td class="graph10" colspan="3">Сведения  о  пользователе: 
				...
				ОКАТО <xsl:value-of select="pex:UserInfo/cat_ru:OKATOCode"/> 
                  ...
                  <xsl:if test="pex:UserInfo/pex:IdentityCard">
                     <xsl:value-of select="pex:UserInfo/pex:IdentityCard/RUScat_ru:IdentityCardName"/> 
				<xsl:if test="pex:UserInfo/pex:IdentityCard/RUScat_ru:IdentityCardSeries">
				серия 
				<xsl:value-of select="pex:UserInfo/pex:IdentityCard/RUScat_ru:IdentityCardSeries"/> 
				</xsl:if>
				номер 
				<xsl:value-of select="pex:UserInfo/pex:IdentityCard/RUScat_ru:IdentityCardNumber"/> 
				выдан  
				<xsl:for-each select="pex:UserInfo/pex:IdentityCard/RUScat_ru:IdentityCardDate">
