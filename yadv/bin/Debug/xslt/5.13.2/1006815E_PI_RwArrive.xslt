...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:catpi_ru="urn:customs.ru:Information:PriorInformation:PriorCommonAggregateTypes:5.13.1" xmlns:pirwa="urn:customs.ru:Information:PriorInformation:PI_RwArrive:5.13.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.13.0">
               ...
               <table border="1">
                  <tbody>
                     ...
                     <xsl:for-each select="pirwa:Train/pirwa:Wagon">
                        ...
                        <xsl:if test="pirwa:ContainerNumbers">
                           <tr>
                              <td colspan="4">
