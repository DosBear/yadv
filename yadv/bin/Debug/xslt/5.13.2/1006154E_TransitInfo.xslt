...
<xsl:stylesheet version="1.0" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.12.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:tci="urn:customs.ru:Information:CustomsDocuments:TransitInfo:5.12.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
                           ...
                           <table align="center" border="1" cellpadding="0" cellspacing="0" style="width:165mm;">
                              <tbody>
                                 <tr>
                                    ...
                                    <td align="center" class="graph" style="width:8%">Код ТН ВЭД</td>
