   ...
   <xsl:template match="kimpc:KimberleyProcessCertificate">
      <html>
         ...
         <table style="width:100%">
            ...
            <br/>
            <tr>
               <td align="center" class="graph12" style="font-weight:900; font-size:25">KIMBERLEY PROCESS CERTIFICATE</td>
            </tr>
            <br/>
            <br/>
            <tr>
