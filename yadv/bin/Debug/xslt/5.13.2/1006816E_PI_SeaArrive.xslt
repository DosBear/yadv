...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:catpi_ru="urn:customs.ru:Information:PriorInformation:PriorCommonAggregateTypes:5.13.1" xmlns:pisa="urn:customs.ru:Information:PriorInformation:PI_SeaArrive:5.13.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.13.0">
			...
			<td colspan="2">
				...
				<span class="text">
					<xsl:choose>
						...
						<xsl:when test="pisa:DrugsType=1">Сильнодействующие</xsl:when>
						<xsl:when test="pisa:DrugsType=1">Психотропные</xsl:when>
						<xsl:when test="pisa:DrugsType=1">Ядовитые</xsl:when>
					</xsl:choose>
				</span>
			</td>
		</tr>
