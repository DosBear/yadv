					...
					<table width="100%">
						<tbody>
							<tr valign="top">
								...
								<td>
									<xsl:call-template name="russian_date"><xsl:with-param name="dateIn" select="grn_bnk:DecisionDateTime"/></xsl:call-template>
									<xsl:text> </xsl:text>
									<xsl:value-of select="substring(grn_bnk:DecisionDateTime,12,8)"/>
								</td>
							</tr>
							<tr>
								<td colspan="2" align="center" style="font-weight:bold;"><br/>Сведения по банковской гарантии</td>
							</tr>
							<tr>
								<td>Номер банковской гарантии</td>
								<td><xsl:value-of select="grn_bnk:GuaranteeInformation/grn_cat:GuaranteeOriginalNumber"/></td>
							</tr>
							<tr>
								<td>Дата выдачи банковской гарантии</td>
								<td><xsl:call-template name="russian_date"><xsl:with-param name="dateIn" select="grn_bnk:GuaranteeInformation/grn_cat:GuaranteeOriginalDate"/></xsl:call-template></td>
							</tr>
							<tr>
								<td>Дата вступления в силу</td>
								<td><xsl:call-template name="russian_date"><xsl:with-param name="dateIn" select="grn_bnk:GuaranteeInformation/grn_cat:StartDate"/></xsl:call-template></td>
							</tr>
							<tr>
								<td>Срок действия</td>
								<td><xsl:call-template name="russian_date"><xsl:with-param name="dateIn" select="grn_bnk:GuaranteeInformation/grn_cat:ExpireDate"/></xsl:call-template></td>
							</tr>
							...
							<tr>
								<td colspan="2" align="center" style="font-weight:bold;"><br/>Сумма банковской гарантии</td>
							</tr>
							<tr>
								<td>Сумма</td>
								<td>
							...
							<tr>
								...
								<td><xsl:value-of select="grn_bnk:GuaranteeInformation/grn_cat:GuaranteeAmount/grn_cat:CurrencyCode"/></td>
							</tr>
							<tr>
								<td colspan="2" align="center" style="font-weight:bold;"><br/>Информация о видах обязательств</td>
							</tr>
							...
							<tr>
								<td colspan="2" align="center" style="font-weight:bold;"><br/>Сведения о гаранте</td>
							</tr>
							<xsl:if test="grn_bnk:Guarantor/cat_ru:OrganizationName">
								<tr>
									<td>Наименование организации</td>
									<td><xsl:value-of select="grn_bnk:Guarantor/cat_ru:OrganizationName"/></td>
								</tr>
							</xsl:if>
							<xsl:if test="grn_bnk:Guarantor/cat_ru:ShortName">
								<tr>
									<td>Краткое наименование организации</td>
									<td><xsl:value-of select="grn_bnk:Guarantor/cat_ru:ShortName"/></td>
								</tr>
							</xsl:if>
							<xsl:if test="grn_bnk:Guarantor/cat_ru:RFOrganizationFeatures/cat_ru:OGRN">
								<tr>
									<td>ОГРН/ОГРНИП</td>
									<td><xsl:value-of select="grn_bnk:Guarantor/cat_ru:RFOrganizationFeatures/cat_ru:OGRN"/></td>
								</tr>
							</xsl:if>
							<xsl:if test="grn_bnk:Guarantor/cat_ru:RFOrganizationFeatures/cat_ru:INN">
								<tr>
									<td>ИНН</td>
									<td><xsl:value-of select="grn_bnk:Guarantor/cat_ru:RFOrganizationFeatures/cat_ru:INN"/></td>
								</tr>
							</xsl:if>
							<xsl:if test="grn_bnk:Guarantor/grn_cat:BICID">
								<tr>
									<td>БИК</td>
									<td><xsl:value-of select="grn_bnk:Guarantor/grn_cat:BICID"/></td>
								</tr>
							</xsl:if>
							<xsl:if test="grn_bnk:Guarantor/grn_cat:CorrAccount">
								<tr>
									<td>Корреспондентский счет</td>
									<td><xsl:value-of select="grn_bnk:Guarantor/grn_cat:CorrAccount"/></td>
								</tr>
							</xsl:if>
							<xsl:if test="grn_bnk:Guarantor/grn_cat:OKPOID">
								<tr>
									<td>ОКПО</td>
									<td><xsl:value-of select="grn_bnk:Guarantor/grn_cat:OKPOID"/></td>
								</tr>
							</xsl:if>
							<tr>
								<td colspan="2" align="center" style="font-weight:bold;"><br/>Сведения о принципале</td>
							</tr>
							<xsl:if test="grn_bnk:Principal/cat_ru:OrganizationName">
								<tr>
									...
									<td><xsl:value-of select="grn_bnk:Principal/cat_ru:OrganizationName"/></td>
								</tr>
							</xsl:if>
							<xsl:if test="grn_bnk:Principal/cat_ru:ShortName">
								<tr>
									...
									<td><xsl:value-of select="grn_bnk:Principal/cat_ru:ShortName"/></td>
								</tr>
							</xsl:if>
							<xsl:if test="grn_bnk:Principal/cat_ru:RFOrganizationFeatures/cat_ru:OGRN">
								<tr>
									<td>ОГРН/ОГРНИП</td>
									<td><xsl:value-of select="grn_bnk:Principal/cat_ru:RFOrganizationFeatures/cat_ru:OGRN"/></td>
								</tr>
							</xsl:if>
							<xsl:if test="grn_bnk:Principal/cat_ru:RFOrganizationFeatures/cat_ru:INN">
								<tr>
									<td>ИНН</td>
									<td><xsl:value-of select="grn_bnk:Principal/cat_ru:RFOrganizationFeatures/cat_ru:INN"/></td>
								</tr>
							</xsl:if>
							<xsl:if test="grn_bnk:Principal/cat_ru:RFOrganizationFeatures/cat_ru:KPP">
								<tr>
									<td>КПП</td>
									<td><xsl:value-of select="grn_bnk:Principal/cat_ru:RFOrganizationFeatures/cat_ru:KPP"/></td>
								</tr>
							</xsl:if>
							<xsl:if test="grn_bnk:Principal/cat_ru:IdentityCard/cat_ru:IdentityCardName">
								<tr>
									<td>Вид документа, удостоверяющего личность</td>
									<td><xsl:value-of select="grn_bnk:Principal/cat_ru:IdentityCard/cat_ru:IdentityCardName"/></td>
								</tr>
							</xsl:if>
							<xsl:if test="grn_bnk:Principal/cat_ru:IdentityCard/cat_ru:IdentityCardSeries or grn_bnk:Principal/cat_ru:IdentityCard/cat_ru:IdentityCardNumber">
								<tr>
									...
									<td><xsl:value-of select="grn_bnk:Principal/cat_ru:IdentityCard/cat_ru:IdentityCardSeries"/> <xsl:value-of select="grn_bnk:Principal/cat_ru:IdentityCard/cat_ru:IdentityCardNumber"/></td>
								</tr>
							</xsl:if>
							<xsl:if test="grn_bnk:Principal/cat_ru:IdentityCard/cat_ru:IdentityCardDate">
								<tr>
									...
									<td><xsl:call-template name="russian_date"><xsl:with-param name="dateIn" select="grn_bnk:Principal/cat_ru:IdentityCard/cat_ru:IdentityCardDate"/></xsl:call-template></td>
								</tr>
							</xsl:if>
							<xsl:if test="grn_bnk:Principal/cat_ru:IdentityCard/cat_ru:OrganizationName">
								<tr>
									...
									<td><xsl:value-of select="grn_bnk:Principal/cat_ru:IdentityCard/cat_ru:OrganizationName"/></td>
								</tr>
							</xsl:if>
							<tr>
								<td colspan="2" align="center" style="font-weight:bold;"><br/>Сведения о бенефициаре</td>
							</tr>
							<tr>
								<td>Код таможенного органа</td>
								<td><xsl:value-of select="grn_bnk:Beneficiary/cat_ru:Code"/></td>
							</tr>
							<xsl:if test="grn_bnk:Beneficiary/cat_ru:OfficeName">
								<tr>
									<td>Наименование таможенного органа</td>
									<td><xsl:value-of select="grn_bnk:Beneficiary/cat_ru:OfficeName"/></td>
								</tr>
							</xsl:if>
						</tbody>
					</table>
