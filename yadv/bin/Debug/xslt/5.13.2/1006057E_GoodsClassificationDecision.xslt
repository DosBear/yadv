				...
				<tbody>
				   <tr>
					  <td colspan="6" style="text-align:center;font-size:10pt;border:0px;border-bottom:1px solid black;">
						  <b>
						  Решение<br/>по классификации товара в несобранном или разобранном виде, в том числе в некомплектном или незавершенном виде, ввоз или вывоз которого предполагается различными товарными партиями в течение установленного периода времени
						  </b>
					  </td>
				   </tr>
				   <tr>
				   ...
				   <tr>
					...
					<tr>
						<td colspan="6">
						10. Реквизиты документов, которые подтверждают совершение внешнеэкономической сделки и в соответствии с которыми будет осуществляться ввоз или вывоз компонентов товара<br/>
				...
				<tbody>
				   <tr>
					  <td colspan="2" style="text-align:center;font-size:10pt;border:0px;border-bottom:1px solid black;">
						  <b>
						  Решение<br/>об отказе в рассмотрении заявления о принятии решения по классификации товара в несобранном или разобранном виде, в том числе в некомплектном или незавершенном виде, ввоз или вывоз которого предполагается различными товарными партиями в течение установленного периода времени<br/>
						  </b>
					  </td>
				   </tr>
				   <tr>
			...
			<table>
				<tbody>
				   <tr>
					  <td colspan="2" style="text-align:center;font-size:10pt;border:0px;border-bottom:1px solid black;">
						  <b>
						  Решение<br/>об отклонении заявления о принятии решения по классификации товара в несобранном или разобранном виде, в том числе в некомплектном или незавершенном виде, ввоз или вывоз которого предполагается различными товарными партиями в течение установленного периода времени<br/>
						  </b>
					  </td>
				   </tr>
				   <tr>
			...
			<table>
				<tbody>
				   <tr>
					  <td colspan="6" style="text-align:center;font-size:10pt;border:0px;border-bottom:1px solid black;">
						  <b>
						  Решение<br/>о внесении изменений в решение по классификации товара в несобранном или разобранном виде, в том числе в некомплектном или незавершенном виде, ввоз или вывоз которого предполагается различными товарными партиями в течение установленного периода времени
						  </b>
					  </td>
				   </tr>
				   <tr>
			...
			<table>
				<tbody>
				   <tr>
					  <td colspan="2" style="text-align:center;font-size:10pt;border:0px;border-bottom:1px solid black;">
						  <b>
						  Решение<br/>об отклонении заявления о внесении изменений в решение по классификации товара в несобранном или разобранном виде, в том числе в некомплектном или незавершенном виде, ввоз или вывоз которого предполагается различными товарными партиями в течение установленного периода времени
						  <br/>
						  </b>
					  </td>
				   </tr>
			...
			<table>
				<tbody>
				   <tr>
					  <td colspan="2" style="text-align:center;font-size:10pt;border:0px;border-bottom:1px solid black;">
						  <b>
						  Решение<br/>о прекращении действия решения по классификации товара в несобранном или разобранном виде, в том числе в некомплектном или незавершенном виде, ввоз или вывоз которого предполагается различными товарными партиями в течение установленного периода времени
							<br/>
						  </b>
					  </td>
				   </tr>
