		...
		<div class="page">
				...
				<tbody align="center" class="graphMain">
					...
					<tr>
						...
						<td width="80%" class="border_bottom">
							<span class="normal"><xsl:value-of select="resa:CustomsIssuedResolution/cat_ru:OfficeName"/></span>
							<xsl:if test="resa:CustomsIssuedResolution/cat_ru:OfficeName">
								<span class="normal"> (</span>
							</xsl:if>
							<span class="normal"><xsl:value-of select="resa:CustomsIssuedResolution/cat_ru:Code"/></span>
							<xsl:if test="resa:CustomsIssuedResolution/cat_ru:OfficeName">
								<span class="normal">)</span>
							</xsl:if>
						</td>
					...
					<tr align="center">
						<td>
							<xsl:choose>
								...
								<xsl:otherwise>о <u>&#160;&#160;&#160;&#160;&#160;</u></xsl:otherwise>
							</xsl:choose>
						</td>
					</tr>
				</tbody>
			...
			<table>
				<tbody align="center" class="graphMain">
					<tr>
						...
						<td width="15%"> </td>
						<td width="40%" class="border_bottom"><xsl:value-of select="resa:ResolutionNumber/resa:Place"/></td>
					</tr>
					<tr class="graphLittle">
						<td width="45%"> </td>
						<td  width="10%"> </td>
				...
				<tbody align="left" class="graphMain">
					...
					<tr>
						<td  class="border_bottom">
							<xsl:for-each select="resa:CustomsIssuedResolution/adt_cat:ApproverPerson">
			...
			<table>
				<tbody align="left" class="graphMain">
					...
					<tr class="graphLittle">
						<td align="center">(указывается проверяемое лицо)</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td>
							<span class="normal">
								...
								пункта 2 статьи 335 Таможенного кодекса Евразийского экономического союза, а также статьей 233 Федерального закона 
								от <u>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;</u> 
								№ <u>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;</u>
			...
			<table>
				<tbody align="left" class="graphMain">
					...
					<tr>
						<td  class="border_bottom">
							<span class="normal"><xsl:apply-templates select="resa:SecondExempReceived" /></span>
							<br/>
						</td>
					</tr>
					<tr class="graphLittle">
