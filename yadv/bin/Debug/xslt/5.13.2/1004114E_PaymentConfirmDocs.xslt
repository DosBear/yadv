...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:paycd="urn:customs.ru:Information:ExchangeDocuments:PaymentConfirmDocs:5.10.0" xmlns:xs="http://www.w3.org/2001/XMLSchema">
			...
			<body>
				<div class="page">
						...
						<tbody>
							<tr>
								<td align="center" class="graphMain">
									<font size="4">
										<b>Сведения о платежных документах,<br/>подтверждающих уплату таможенных платежей</b><br/><br/>
									</font>
								</td>
							</tr>
						</tbody>
					...
					<div class="annot graphMain">
						Регистрационный  номер таможенного документа,<br/>на основании которого осуществляется таможенное декларирование:
						<xsl:choose>
					...
					<div>
					<div class="marg-top">Платежные документы</div>
						<table class="bordered w190">
							<tbody>
								...
								<xsl:for-each select="paycd:PaymentDocument">
									<tr>
										<td class="graphLight bordered"><xsl:value-of select="position()"/></td>
										<td class="graphLight bordered">
										...
										<td class="graphLight bordered"><xsl:value-of select="paycd:Amount"/></td>
										<td class="graphLight bordered"><xsl:value-of select="paycd:TotalAmount"/></td>
										<td class="graphLight bordered"><xsl:value-of select="paycd:PaymentMethodCode"/></td>
										<td class="graphLight bordered"><xsl:value-of select="paycd:CurrencyCode"/></td>
									</tr>
								</xsl:for-each>
							</tbody>
						</table>
								...
								<tr>
									...
									<td class="graphMain bb" style="width:130mm">
										...
										<xsl:if test="paycd:Payer/cat_ru:Contact/cat_ru:Fax">
											<xsl:text>факс: </xsl:text><xsl:value-of select="paycd:Payer/cat_ru:Contact/cat_ru:Fax"/>
										</xsl:if>
									</td>
								</tr>
							</xsl:if>
					...
					<xsl:if test="paycd:Comment">
						...
						<table class="w190">
							<tr>
								<td class="annot graphMain" style="width:50%">Примечание: <xsl:value-of select="paycd:Comment"/></td>
							</tr>
						</table>
					</xsl:if>
				</div>
