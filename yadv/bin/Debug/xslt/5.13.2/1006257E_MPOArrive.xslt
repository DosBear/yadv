...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.13.0" xmlns:mpco="urn:customs.ru:Information:CustomsDocuments:MPOCommon:5.13.2" xmlns:mpoa="urn:customs.ru:Information:CustomsDocuments:MPOArrive:5.13.2">
	...
	<xsl:template match="mpoa:Inspection">
		...
		<table class="w190">
			<tr>
				...
				<td class="value graphMain" style="width:50%">
					<xsl:value-of select="translate(mpoa:InspectionTime, '.', ',')"/>
				</td>
			</tr>
		</table>
