...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.13.0" xmlns:catpi_ru="urn:customs.ru:Information:PriorInformation:PriorCommonAggregateTypes:5.13.1" xmlns:pinc="urn:customs.ru:Information:PriorInformation:PI_NoCustoms:5.13.1">
	...
	<xsl:template match="pinc:Goods">
		<tr style="border-top: 3px solid gray;">
			...
			<td class="graphMain bordered" style="width:82%" colspan="5">
				<i><xsl:value-of select="pinc:GoodsName"/></i><br/>
				<xsl:for-each select="catpi_ru:GoodsDescription"><xsl:value-of select="."/></xsl:for-each>
		...
		<xsl:if test="pinc:BorderCustoms">
			<table class="w190">
				<tr>
					...
					<td class="value graphMain" style="width:50%"><xsl:apply-templates select="pinc:BorderCustoms"/></td>
				</tr>
			</table>
		</xsl:if>
		<br/>
	...
	<xsl:template match="pinc:ShippingInformation">
		...
		<xsl:if test="pinc:DispatchCountry">
			<table class="w190">
				<tr>
					...
					<td class="value graphMain" style="width:50%"><xsl:apply-templates select="pinc:DispatchCountry"/></td>
				</tr>
			</table>
		</xsl:if>
		<xsl:if test="pinc:DestinationCountry">
			<table class="w190">
				<tr>
					...
					<td class="value graphMain" style="width:50%"><xsl:apply-templates select="pinc:DestinationCountry"/></td>
				</tr>
			</table>
		</xsl:if>
		<xsl:if test="pinc:BorderTransport">
			<div class="marg-top"><i>Транспортное средство</i></div>
			<table class="bordered w190">
				<tbody>
					<tr class="title">
		...
		<xsl:if test="pinc:TransControl">
			<div class="marg-top"><i>Транспортный контроль</i></div>
			<table class="bordered w190">
				<tbody>
					<tr class="title">
		...
		<tr>
			...
			<td class="graphMain bordered">
				<xsl:choose>
					...
					<xsl:otherwise><xsl:value-of select="catpi_ru:ForeignKind"/></xsl:otherwise>
				</xsl:choose>
			</td>
			<td class="graphMain bordered">
