            ...
            <div class="page">
               <table cellpadding="0" cellspacing="0" style="width:100%;border:solid 0pt #000000;">
                  <tbody>
                     ...
                     <tr>
                        <td class="graphMain" style="width:{83}mm;">ПРЕДВАРИТЕЛЬНАЯ ИНФОРМАЦИЯ В ЦЕЛЯХ ДЕКЛАРИРОВАНИЯ ТОВАРОВ
