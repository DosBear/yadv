...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:pn="urn:customs.ru:Information:ExchangeDocuments:ProlongationNotif:5.13.2" xmlns:mpco="urn:customs.ru:Information:CustomsDocuments:MPOCommon:5.13.2" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
               ...
               <table>
                  ...
                  <xsl:if test="pn:DocSign='0' or pn:DocSign='1'">
					  <xsl:if test="pn:ProlongDate">
						  <tr>
							 <td class="graph" style="border:solid 0pt">Дата, до которой продлевается срок: 
