		...
		<div class="page">
			...
			<table>
				<tbody align="left" class="graphMain">
					...
					<tr class="graphLittle">
						<td align="center">(наименование, ОГРН, ИНН, КПП юридического лица/фамилия, имя, отчество (отчество указывается при наличии), ОГРНИП, ИНН индивидуального предпринимателя; дата и номер заявления)
						</td>
					</tr>
					<tr class="delim"><td> </td></tr>
					<tr>
					...
					<tr>
						<td  class="border_bottom">
							<xsl:for-each select="puag:CustomsIssuedResolution/adt_cat:ApproverPerson">
								<xsl:if test="cat_ru:PersonPost">
									<xsl:value-of select="cat_ru:PersonPost"/>&#160;
								</xsl:if>
								<xsl:value-of select="cat_ru:PersonSurname"/>&#160;
				...
				<tbody align="left" class="graphMain">
					<tr class="graphMain" align="center">
						<td width="60%" class="border_bottom"> 
							<xsl:apply-templates select="puag:SecondExempReceived"/>
							<br/>
						</td>
						<td width="10%"> </td>
					...
					<tr class="value" align="center">
						<td width="45%" align="left">
							<xsl:call-template name="Date">
								<xsl:with-param name="date" select="puag:SecExempDate"/>
							</xsl:call-template>
						</td>
						<td width="25%" align="left">
							<xsl:call-template name="Time">
								<xsl:with-param name="time" select="puag:SecExempTime"/>
							</xsl:call-template>
						</td>
		...
		<table>
			<tbody align="center" class="graphMain">
				<tr>
					...
					<td width="2%" align="right"> </td>
					<td width="44%" class="value" align="center"><xsl:value-of select="substring($time,1, 2)"/></td>
					<td width="2%" align="right"> </td>
					<td width="2%" align="right">ч.</td>
					<td width="2%" align="right"> </td>
					<td width="44%" class="value" align="center"><xsl:value-of select="substring($time, 4, 2)"/></td>
					<td width="2%" align="right"> </td>
