<?xml version="1.0" encoding="utf-8" ?><xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.13.3" xmlns:rlog="urn:customs.ru:Information:SQDocuments:RegistratedListsOfGoods:5.13.3">
 <!-- Шаблон для типа RegistratedListsOfGoodsType -->
<xsl:template match="rlog:RegistratedListsOfGoods">
<html><head><style>
									body {
									background: #cccccc;
									}
								...
								</style></head><body><div class="page"><table class="w190"><tbody><tr><td align="center" class="graphMain"><font size="4"><b>Сведения о зарегистрированных перечнях и списках кооперации</b></font></td></tr></tbody></table><table class="w190"><tr><td class="annot graphMain" style="width:50%">Уникальный идентификатор документа</td><td class="value graphMain" style="width:50%"><xsl:value-of select="cat_ru:DocumentID" /></td></tr></table><xsl:if test="cat_ru:RefDocumentID"><table class="w190"><tr><td class="annot graphMain" style="width:50%">Уникальный идентификатор исходного документа</td><td class="value graphMain" style="width:50%"><xsl:value-of select="cat_ru:RefDocumentID" /></td></tr></table></xsl:if><div class="title marg-top">Сведения о зарегистрированном перечне и списке кооперации</div><table class="bordered w190"><tbody><tr class="title"><td class="graphMain bordered">Наименование документа: 1 - зарегистрированный перечень кооперации; 2 - зарегистрированный список кооперации</td><td class="graphMain bordered">Регистрационный номер ФТС</td><td class="graphMain bordered">Внутренний номер Минпромторга</td><td class="graphMain bordered">Дата формирования</td><td class="graphMain bordered">Дата начала действия</td><td class="graphMain bordered">Дата окончания действия</td><td class="graphMain bordered">Направление перемещения товаров</td><td class="graphMain bordered">Сведения о международном соглашении(договоре), в рамках которго ввозятся товары</td><td class="graphMain bordered">Сведения о таможенном органе, уполномоченном на совершение операций</td><td class="graphMain bordered">Отправитель</td><td class="graphMain bordered">Получатель</td><td class="graphMain bordered">Сведения о товаре</td><td class="graphMain bordered">Уполномоченное лицо со стороны Минпромторга</td><td class="graphMain bordered">Уполномоченное лицо со стороны ФТС</td><td class="graphMain bordered">Статус подтверждения: 1 - подтверждение действует; 2 - подтверждение аннулировано</td><td class="graphMain bordered">Дополнительная информация о статусе</td><td class="graphMain bordered">Дата аннулирования подтверждения</td><td class="graphMain bordered">Информация о дате и времени последнего изменения</td></tr><xsl:for-each select="rlog:RegistratedListOfGoods"><xsl:apply-templates select="."></xsl:apply-templates></xsl:for-each></tbody></table></div></body></html></xsl:template>
...
<xsl:template match="rlog:FTSAuthorizedPerson">
...
<!-- Шаблон для типа rlog:GoodsInfoType -->
<xsl:template match="rlog:GoodsInfo">
<tr><td class="graphMain bordered"><xsl:value-of select="rlog:Number" /></td><td class="graphMain bordered"><xsl:value-of select="rlog:GoodName" /></td><td class="graphMain bordered"><xsl:value-of select="rlog:TNVEDCode" /></td><td class="graphMain bordered"><xsl:apply-templates select="rlog:Quantity" /></td><td class="graphMain bordered"><xsl:if test="rlog:SupplementaryQuantity"><xsl:apply-templates select="rlog:SupplementaryQuantity" /></xsl:if></td></tr></xsl:template>

<!-- Шаблон для типа cat_ru:PersonBaseType -->
<xsl:template match="rlog:MinpromtorgAuthorizedPerson">
<table class="w190"><tr><td class="annot graphMain" style="width:50%">Фамилия</td><td class="value graphMain" style="width:50%"><xsl:value-of select="cat_ru:PersonSurname" /></td></tr></table><table class="w190"><tr><td class="annot graphMain" style="width:50%">Имя</td><td class="value graphMain" style="width:50%"><xsl:value-of select="cat_ru:PersonName" /></td></tr></table><xsl:if test="cat_ru:PersonMiddleName"><table class="w190"><tr><td class="annot graphMain" style="width:50%">Отчество</td><td class="value graphMain" style="width:50%"><xsl:value-of select="cat_ru:PersonMiddleName" /></td></tr></table></xsl:if><xsl:if test="cat_ru:PersonPost"><table class="w190"><tr><td class="annot graphMain" style="width:50%">Должность</td><td class="value graphMain" style="width:50%"><xsl:value-of select="cat_ru:PersonPost" /></td></tr></table></xsl:if></xsl:template>

<!-- Шаблон для типа cat_ru:SupplementaryQuantityType -->
<xsl:template match="rlog:Quantity">
...
<!-- Шаблон для типа rlog:OrganizationWithOtherInfo -->
<xsl:template match="rlog:Receiver">
<xsl:if test="RUScat_ru:OrganizationName"><table class="w190"><tr><td class="annot graphMain" style="width:50%">Наименование организации / ФИО физического лица</td><td class="graphMain value" style="width:50%"><xsl:for-each select="RUScat_ru:OrganizationName"><xsl:value-of select="." /><xsl:if test="position()!=last()"><xsl:text>, </xsl:text></xsl:if></xsl:for-each></td></tr></table></xsl:if><xsl:if test="RUScat_ru:ShortName"><table class="w190"><tr><td class="annot graphMain" style="width:50%">Краткое наименование организации</td><td class="value graphMain" style="width:50%"><xsl:value-of select="RUScat_ru:ShortName" /></td></tr></table></xsl:if><xsl:if test="RUScat_ru:OrganizationLanguage"><table class="w190"><tr><td class="annot graphMain" style="width:50%">Код языка для заполнения наименования </td><td class="value graphMain" style="width:50%"><xsl:value-of select="RUScat_ru:OrganizationLanguage" /></td></tr></table></xsl:if><xsl:if test="RUScat_ru:RFOrganizationFeatures"><div class="title marg-top">Сведения об организации. Особенности Российской Федерации</div></xsl:if><xsl:apply-templates select="RUScat_ru:RFOrganizationFeatures" /><xsl:if test="RUScat_ru:RKOrganizationFeatures"><div class="title marg-top">Сведения об организации. Особенности Республики Казахстан</div></xsl:if><xsl:apply-templates select="RUScat_ru:RKOrganizationFeatures" /><xsl:if test="RUScat_ru:RBOrganizationFeatures"><div class="title marg-top">Сведения об организации. Особенности Республики Беларусь</div></xsl:if><xsl:apply-templates select="RUScat_ru:RBOrganizationFeatures" /><xsl:if test="RUScat_ru:RAOrganizationFeatures"><div class="title marg-top">Сведения об организации. Особенности Республики Армения</div></xsl:if><xsl:apply-templates select="RUScat_ru:RAOrganizationFeatures" /><xsl:if test="RUScat_ru:KGOrganizationFeatures"><div class="title marg-top">Сведения об организации. Особенности Кыргызской Республики</div></xsl:if><xsl:apply-templates select="RUScat_ru:KGOrganizationFeatures" /><xsl:if test="RUScat_ru:Address"><table class="w190"><tr><td class="annot graphMain" style="width:50%">Юридический адрес</td><td class="value graphMain" style="width:50%"><xsl:value-of select="RUScat_ru:Address" /></td></tr></table></xsl:if><xsl:if test="rlog:OtherInfo"><table class="w190"><tr><td class="annot graphMain" style="width:50%">Иные сведения</td><td class="value graphMain" style="width:50%"><xsl:value-of select="rlog:OtherInfo" /></td></tr></table></xsl:if></xsl:template>

<!-- Шаблон для типа rlog:RegistratedListOfGoodsType -->
<xsl:template match="rlog:RegistratedListOfGoods">
<tr><td class="graphMain bordered"><xsl:choose><xsl:when test="rlog:DocumentType=1"><xsl:text>зарегистрированный перечень кооперации</xsl:text></xsl:when><xsl:when test="rlog:DocumentType=2"><xsl:text>зарегистрированный список кооперации</xsl:text></xsl:when><xsl:otherwise><xsl:value-of select="rlog:DocumentType" /></xsl:otherwise></xsl:choose></td><td class="graphMain bordered"><xsl:value-of select="rlog:FTSRegNumber" /></td><td class="graphMain bordered"><xsl:value-of select="rlog:MinpromtorgRegNumber" /></td><td class="graphMain bordered"><xsl:call-template name="russian_date"><xsl:with-param name="dateIn" select="rlog:Date" /></xsl:call-template></td><td class="graphMain bordered"><xsl:call-template name="russian_date"><xsl:with-param name="dateIn" select="rlog:DateBegin" /></xsl:call-template></td><td class="graphMain bordered"><xsl:call-template name="russian_date"><xsl:with-param name="dateIn" select="rlog:DateEnd" /></xsl:call-template></td><td class="graphMain bordered"><xsl:value-of select="rlog:MovingDirection" /></td><td class="graphMain bordered"><xsl:apply-templates select="rlog:Agreement" /></td><td class="graphMain bordered"><xsl:apply-templates select="rlog:CustomsOffice" /></td><td class="graphMain bordered"><xsl:apply-templates select="rlog:Sender" /></td><td class="graphMain bordered"><xsl:apply-templates select="rlog:Receiver" /></td><td class="graphMain bordered"><div class="title marg-top">Сведения о товаре</div><table class="bordered w190"><tbody><tr class="title"><tr><td class="graphMain bordered">Номер позиции товара в перечне (списке)</td><td class="graphMain bordered">Краткое наименование товара</td><td class="graphMain bordered">Код товара по ТН ВЭД ЕАЭС</td><td class="graphMain bordered">Количество товара в основной единице измерения</td><td class="graphMain bordered">Количество товара в дополнительной единице измерения</td></tr></tr><xsl:for-each select="rlog:GoodsInfo"><xsl:apply-templates select="."></xsl:apply-templates></xsl:for-each></tbody></table></td><td class="graphMain bordered"><xsl:apply-templates select="rlog:MinpromtorgAuthorizedPerson" /></td><td class="graphMain bordered"><xsl:apply-templates select="rlog:FTSAuthorizedPerson" /></td><td class="graphMain bordered"><xsl:choose><xsl:when test="rlog:Status=1"><xsl:text>подтверждение действует</xsl:text></xsl:when><xsl:when test="rlog:Status=2"><xsl:text>подтверждение аннулировано</xsl:text></xsl:when><xsl:otherwise><xsl:value-of select="rlog:Status" /></xsl:otherwise></xsl:choose></td><td class="graphMain bordered"><xsl:value-of select="rlog:StatusInfo" /></td><td class="graphMain bordered"><xsl:call-template name="russian_date"><xsl:with-param name="dateIn" select="rlog:AnnulmentDate" /></xsl:call-template></td><td class="graphMain bordered"><xsl:value-of select="rlog:LastChangeDateTime" /></td></tr></xsl:template>

<!-- Шаблон для типа rlog:OrganizationWithOtherInfo -->
<xsl:template match="rlog:Sender">
<xsl:if test="RUScat_ru:OrganizationName"><table class="w190"><tr><td class="annot graphMain" style="width:50%">Наименование организации / ФИО физического лица</td><td class="graphMain value" style="width:50%"><xsl:for-each select="RUScat_ru:OrganizationName"><xsl:value-of select="." /><xsl:if test="position()!=last()"><xsl:text>, </xsl:text></xsl:if></xsl:for-each></td></tr></table></xsl:if><xsl:if test="RUScat_ru:ShortName"><table class="w190"><tr><td class="annot graphMain" style="width:50%">Краткое наименование организации</td><td class="value graphMain" style="width:50%"><xsl:value-of select="RUScat_ru:ShortName" /></td></tr></table></xsl:if><xsl:if test="RUScat_ru:OrganizationLanguage"><table class="w190"><tr><td class="annot graphMain" style="width:50%">Код языка для заполнения наименования </td><td class="value graphMain" style="width:50%"><xsl:value-of select="RUScat_ru:OrganizationLanguage" /></td></tr></table></xsl:if><xsl:if test="RUScat_ru:RFOrganizationFeatures"><div class="title marg-top">Сведения об организации. Особенности Российской Федерации</div></xsl:if><xsl:apply-templates select="RUScat_ru:RFOrganizationFeatures" /><xsl:if test="RUScat_ru:RKOrganizationFeatures"><div class="title marg-top">Сведения об организации. Особенности Республики Казахстан</div></xsl:if><xsl:apply-templates select="RUScat_ru:RKOrganizationFeatures" /><xsl:if test="RUScat_ru:RBOrganizationFeatures"><div class="title marg-top">Сведения об организации. Особенности Республики Беларусь</div></xsl:if><xsl:apply-templates select="RUScat_ru:RBOrganizationFeatures" /><xsl:if test="RUScat_ru:RAOrganizationFeatures"><div class="title marg-top">Сведения об организации. Особенности Республики Армения</div></xsl:if><xsl:apply-templates select="RUScat_ru:RAOrganizationFeatures" /><xsl:if test="RUScat_ru:KGOrganizationFeatures"><div class="title marg-top">Сведения об организации. Особенности Кыргызской Республики</div></xsl:if><xsl:apply-templates select="RUScat_ru:KGOrganizationFeatures" /><xsl:if test="RUScat_ru:Address"><table class="w190"><tr><td class="annot graphMain" style="width:50%">Юридический адрес</td><td class="value graphMain" style="width:50%"><xsl:value-of select="RUScat_ru:Address" /></td></tr></table></xsl:if><xsl:if test="rlog:OtherInfo"><table class="w190"><tr><td class="annot graphMain" style="width:50%">Иные сведения</td><td class="value graphMain" style="width:50%"><xsl:value-of select="rlog:OtherInfo" /></td></tr></table></xsl:if></xsl:template>

<!-- Шаблон для типа cat_ru:SupplementaryQuantityType -->
<xsl:template match="rlog:SupplementaryQuantity">
<table class="w190"><tr><td class="annot graphMain" style="width:50%">Количество товара в единице измерения</td><td class="value graphMain" style="width:50%"><xsl:value-of select="translate(cat_ru:GoodsQuantity, '.', ',')" /></td></tr></table><xsl:if test="cat_ru:MeasureUnitQualifierName"><table class="w190"><tr><td class="annot graphMain" style="width:50%">Условное обозначение единицы измерения</td><td class="value graphMain" style="width:50%"><xsl:value-of select="cat_ru:MeasureUnitQualifierName" /></td></tr></table></xsl:if><xsl:if test="cat_ru:MeasureUnitQualifierCode"><table class="w190"><tr><td class="annot graphMain" style="width:50%">Код единицы измерения в соответствии с единицами измерения, применяемыми в ТН ВЭД ЕАЭС</td><td class="value graphMain" style="width:50%"><xsl:value-of select="cat_ru:MeasureUnitQualifierCode" /></td></tr></table></xsl:if></xsl:template>
