...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.13.3" xmlns:fssp_epd_res="urn:customs.ru:Information:SQDocuments:FsspExecutoryProcessDebtorsResponse:5.13.3">
	<!-- Шаблон для типа FsspExecutoryProcessDebtorsResponseType -->
	<xsl:template match="fssp_epd_res:FsspExecutoryProcessDebtorsResponse">
		<html>
			<head>
				<style>
					body {
				...
				<div class="page">
						...
						<tbody>
							<tr>
								<td align="center" class="graphMain">
									<font size="4">
										<b>Сведения из системы ЕАИС таможенных органов по запросу судебного пристава-исполнителя сведений о должниках по исполнительным производствам, стороной которого он является</b>
									</font>
								</td>
							</tr>
						</tbody>
					...
					<table class="w190">
						<tr>
							...
							<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_epd_res:ConversationId"/></td>
						</tr>
						<tr>
							<td class="annot graphMain" style="width:50%">Идентификатор ИД АИС ведомства</td>
							<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_epd_res:EaisId"/></td>
						</tr>
						<tr>
							<td class="annot graphMain" style="width:50%">Ключ запроса ФССП России</td>
							<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_epd_res:RequestKey"/></td>
						</tr>
						<tr>
							<td class="annot graphMain" style="width:50%">Ключ ИП ФССП России</td>
							<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_epd_res:ExecutoryProcessKey"/></td>
						</tr>
						<tr>
							<td class="annot graphMain" style="width:50%">Тип ответа</td>
							<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_epd_res:ResponseType"/></td>
						</tr>
						<tr>
							<td class="annot graphMain" style="width:50%">Дата ответа</td>
							<td class="value graphMain" style="width:50%">
								<xsl:call-template name="russian_date">
									<xsl:with-param name="dateIn" select="fssp_epd_res:ResponseDate"/>
								</xsl:call-template>
							</td>
						</tr>
						<tr>
							<td class="annot graphMain" style="width:50%">ФИО и должность лица</td>
							<td class="value graphMain" style="width:50%"><xsl:apply-templates select="fssp_epd_res:Executive"/></td>
						</tr>
						<tr>
							<td class="annot graphMain" style="width:50%">Электронная почта</td>
							<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_epd_res:ExecutiveEmail"/></td>
						</tr>
						<tr>
							<td class="annot graphMain" style="width:50%">Контактный телефон</td>
							<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_epd_res:ExecutivePhone"/></td>
						</tr>
					</table>
					<div class="title marg-top">Сведения о должнике</div>
					<xsl:apply-templates select="fssp_epd_res:Information"/>
				</div>
			</body>
		</html>
	</xsl:template>
	...
	<xsl:template match="fssp_epd_res:Address| fssp_epd_res:DebtorAddress">
	...
	<xsl:template match="fssp_epd_res:DebtorLegalEntity">
		<table class="w190">
	...
	<xsl:template match="fssp_epd_res:DebtorName | fssp_epd_res:Executive">
		<xsl:value-of select="cat_ru:PersonSurname"/>&#160;
		<xsl:value-of select="cat_ru:PersonName"/>&#160;
		<xsl:value-of select="cat_ru:PersonMiddleName"/>
		<xsl:if test="cat_ru:PersonPost">, должность: <xsl:value-of select="cat_ru:PersonPost"/></xsl:if>
	</xsl:template>
	<!-- Шаблон для типа fssp_epd_res:PrivatePersonType -->
	<xsl:template match="fssp_epd_res:DebtorPrivatePerson">
		<table class="w190">
			<tr>
				<td class="annot graphMain" style="width:50%">ФИО должника</td>
				<td class="graphMain value" style="width:50%"><xsl:apply-templates select="fssp_epd_res:DebtorName"/></td>
			</tr>
			<tr>
				<td class="annot graphMain" style="width:50%">Дата рождения</td>
				<td class="value graphMain" style="width:50%">
					<xsl:call-template name="russian_date">
						<xsl:with-param name="dateIn" select="fssp_epd_res:BirthDate"/>
					</xsl:call-template>
				</td>
			</tr>
			<xsl:if test="fssp_epd_res:BirthPlace">
				<tr>
					<td class="annot graphMain" style="width:50%">Место рождения</td>
					<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_epd_res:BirthPlace"/></td>
				</tr>
			</xsl:if>
			<tr>
				...
				<td class="value graphMain" style="width:50%">
					<xsl:choose>
						<xsl:when test="fssp_epd_res:Gender='1'">Мужской</xsl:when>
						<xsl:when test="fssp_epd_res:Gender='2'">Женский</xsl:when>
			...
			<tr>
				...
				<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_epd_res:INN"/></td>
			</tr>
			<xsl:if test="fssp_epd_res:OGRN">
				<tr>
					<td class="annot graphMain" style="width:50%">ОГРНИП</td>
					<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_epd_res:OGRN"/></td>
				</tr>
			</xsl:if>
			<xsl:if test="fssp_epd_res:SNILS">
				<tr>
					<td class="annot graphMain" style="width:50%">СНИЛС</td>
					<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_epd_res:SNILS"/></td>
				</tr>
			</xsl:if>
			<xsl:if test="fssp_epd_res:IdentityCard">
				<tr>
					<td class="annot graphMain" style="width:50%">Удостоверение личности</td>
					<td class="value graphMain" style="width:50%"><xsl:apply-templates select="fssp_epd_res:IdentityCard"/></td>
				</tr>
			</xsl:if>
			<xsl:if test="fssp_epd_res:Address">
				<tr>
					<td class="annot graphMain" style="width:50%">Адрес</td>
					<td class="value graphMain" style="width:50%"><xsl:apply-templates select="fssp_epd_res:Address"/></td>
				</tr>
			</xsl:if>
		</table>
	</xsl:template>
	<!-- Шаблон для типа fssp_epd_res:GoodInfoType -->
	<xsl:template match="fssp_epd_res:GoodInfo">
		<tr>
			<td class="graphMain bordered"><xsl:value-of select="fssp_epd_res:Status"/></td>
			<td class="graphMain bordered"><xsl:value-of select="fssp_epd_res:Name"/></td>
			<td class="graphMain bordered"><xsl:value-of select="translate(fssp_epd_res:Cost, '.', ',')"/></td>
			<td class="graphMain bordered"><xsl:value-of select="translate(fssp_epd_res:Quantity, '.', ',')"/></td>
			<td class="graphMain bordered">
				<xsl:call-template name="russian_date">
					<xsl:with-param name="dateIn" select="fssp_epd_res:StorageDate"/>
				</xsl:call-template>
			</td>
			<td class="graphMain bordered"><xsl:value-of select="fssp_epd_res:StoragePlace"/></td>
			<td class="graphMain bordered"><xsl:value-of select="fssp_epd_res:AdditionalInformation"/></td>
		</tr>
	</xsl:template>
	<!-- Шаблон для типа fssp_epd_res:GoodsType -->
	<xsl:template match="fssp_epd_res:Goods">
		<table class="bordered w190">
			...
			<xsl:for-each select="fssp_epd_res:GoodInfo">
				<xsl:apply-templates select="."/>
			</xsl:for-each>
		</table>
	</xsl:template>
	<!-- Шаблон для типа RUScat_ru:RUIdentityCardType -->
	<xsl:template match="fssp_epd_res:IdentityCard">
	...
	<!-- Шаблон для типа fssp_epd_res:InformationType -->
	<xsl:template match="fssp_epd_res:Information">
		<xsl:if test="fssp_epd_res:DebtorPrivatePerson">
			<div class="marg-top2">Физическое лицо</div>
			<xsl:apply-templates select="fssp_epd_res:DebtorPrivatePerson"/>
		</xsl:if>
		<xsl:if test="fssp_epd_res:DebtorLegalEntity">
			<div class="marg-top2">Юридическое лицо</div>
			<xsl:apply-templates select="fssp_epd_res:DebtorLegalEntity"/>
		</xsl:if>
		<table class="w190">
			<xsl:if test="fssp_epd_res:DebtorAddress">
				<tr>
					<td class="annot graphMain" style="width:50%">Адрес в расшифровке</td>
					<td class="value graphMain" style="width:50%"><xsl:apply-templates select="fssp_epd_res:DebtorAddress"/></td>
				</tr>
			</xsl:if>
			<xsl:if test="fssp_epd_res:DebtorPhone">
				<tr>
					<td class="annot graphMain" style="width:50%">Телефон должника</td>
					<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_epd_res:DebtorPhone"/></td>
				</tr>
			</xsl:if>
		</table>
		<div class="marg-top2">Сведения о товарах</div>
		<xsl:apply-templates select="fssp_epd_res:Goods"/>
	</xsl:template>
