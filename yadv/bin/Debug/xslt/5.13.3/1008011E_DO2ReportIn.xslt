...
<xsl:stylesheet exclude-result-prefixes="catWH_ru cat_ru do2r_in" version="1.0" xmlns:catWH_ru="urn:customs.ru:Information:WarehouseDocuments:WarehouseCommonAggregateTypesCust:5.13.1" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:do2r_in="urn:customs.ru:Information:WarehouseDocuments:DO2ReportIn:5.13.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
      ...
      <table width="270mm">
         <tbody>
            ...
            <tr>
               <td>
                  <xsl:choose>
                     <xsl:when test="(do2r_in:GoodsShipment/do2r_in:MPOSign=0) or (do2r_in:GoodsShipment/do2r_in:MPOSign='f') or (do2r_in:GoodsShipment/do2r_in:MPOSign='false')">
                        <table border="1" style="width:250mm">
                           ...
                           <tr>
                              ...
                              <!--6-->
                              <td style="width:15mm">Код товара в соответствии с ГС или ТН ВЭД</td>
                              <!--7-->
                           ...
                           <xsl:for-each select="do2r_in:GoodsShipment/do2r_in:Goods">
                              <xsl:variable name="Input" select="count(do2r_in:Input)"/>
                              <xsl:for-each select="do2r_in:Input">
                                 ...
                                 <tr>
                                    ...
                                    <td style="width:11mm">
                                       <xsl:call-template name="russian_date">
                                          <xsl:with-param name="dateIn" select="do2r_in:DO1GoodLink/do2r_in:DO1Date"/>
                                       </xsl:call-template>
                                       <!--br/>
                                       <xsl:value-of select="do2r_in:DO1GoodLink/do2r_in:DO1Time"/-->
                                    </td>
                                    <!--3 Номер отчета по форме ДО1мв-->
                                    <td style="width:8mm">
                                       <xsl:value-of select="do2r_in:DO1GoodLink/do2r_in:DO1Number"/>
                                    </td>
                                    <!--4 Порядковый номер товаров в отчете по форме ДО1мв-->
                                    <td style="width:10mm">
                                       <xsl:value-of select="do2r_in:DO1GoodLink/do2r_in:DO1GoodNumber"/>
                                    </td>
                                    <!--5 Наименование товара-->
                                    <td style="width:18mm">
                                       <xsl:value-of select="catWH_ru:GoodsDescription"/>
                                    </td>
                                    <!--6 Код товара в соответствии с ГС или ТН ВЭД-->
                                    <td style="width:15mm">
                                       <xsl:value-of select="catWH_ru:GoodsTNVEDCode"/>
                                    </td>
                                    <!--7 складской номер-->
                                    <td style="width:11mm">
                                       <xsl:value-of select="do2r_in:WHNumber"/>
                                    </td>
						...
						<xsl:value-of select="catWH_ru:MeasureQuantity/catWH_ru:MeasureUnitQualifierCode"/>
                                    ...
                                    <td style="width:12mm">
                                       <xsl:call-template name="russian_date">
                                          <xsl:with-param name="dateIn" select="do2r_in:KeepingLimit/do2r_in:DeadLineDate"/>
                                       </xsl:call-template>
                                    </td>
                                    <xsl:choose>
                                       <xsl:when test="$pos=1">
                                          ...
                                          <td style="width:12mm">
                                             ...
                                             <xsl:call-template name="russian_date">
                                                <xsl:with-param name="dateIn" select="../do2r_in:Output/do2r_in:OutputDate"/>
                                             </xsl:call-template>
                                             <br/>
                                             <xsl:value-of select="../do2r_in:Output/do2r_in:OutputTime"/>
                                          </td>
                                          ...
                                          <td style="width:7mm">
                                             ...
                                             <xsl:value-of select="../do2r_in:Output/do2r_in:CargoPlace/catWH_ru:PlaceNumber"/>
                                          </td>
                                          ...
                                          <td style="width:16mm">
                                             ...
                                             <xsl:value-of select="../do2r_in:Output/do2r_in:BruttoVolQuant/catWH_ru:GoodsQuantity"/> 
						<xsl:value-of select="../do2r_in:Output/do2r_in:BruttoVolQuant/catWH_ru:MeasureUnitQualifierName"/> 
						<xsl:value-of select="../do2r_in:Output/do2r_in:BruttoVolQuant/catWH_ru:MeasureUnitQualifierCode"/>
                                             <br/>
                                             <xsl:value-of select="../do2r_in:Output/do2r_in:MeasureQuantity/catWH_ru:GoodsQuantity"/> 
						<xsl:value-of select="../do2r_in:Output/do2r_in:MeasureQuantity/catWH_ru:MeasureUnitQualifierName"/> 
						<xsl:value-of select="../do2r_in:Output/do2r_in:MeasureQuantity/catWH_ru:MeasureUnitQualifierCode"/>
                                          </td>
                                          ...
                                          <td style="width:17mm">
                                             ...
                                             <xsl:value-of select="../do2r_in:Output/do2r_in:Cost"/> 
						<xsl:value-of select="../do2r_in:Output/do2r_in:CurrencyCode"/>
                                          </td>
                                          ...
                                          <td style="width:17mm">
                                             ...
                                             <!--xsl:variable name="doc" select="../../do2r_in:GoodsCustomDocsLinks/do2r_in:CustomDocNumber"/><xsl:value-of select="$doc"/-->
                                             <xsl:variable name="Num" select="catWH_ru:GoodsNumber"/>
                                             <xsl:for-each select="(../../do2r_in:GoodsCustomDocsLinks)">
                                                <xsl:variable name="doc" select="do2r_in:CustomDocNumber"/>
                                                <xsl:if test="(do2r_in:GoodNumber)=$Num">
                                                   <xsl:for-each select="../do2r_in:CustomsDocs[position()=$doc]">
													   <xsl:if test="catWH_ru:DocumentCode">(<xsl:value-of select="catWH_ru:DocumentCode"/>) </xsl:if>
                                                      <xsl:value-of select="cat_ru:PrDocumentName"/>
													  <xsl:if test="cat_ru:PrDocumentNumbe"> № <xsl:value-of select="cat_ru:PrDocumentNumber"/></xsl:if>	
													  <xsl:if test="cat_ru:PrDocumentDate">
														  <xsl:text> от </xsl:text>
														  <xsl:call-template name="russian_date"><xsl:with-param name="dateIn" select="cat_ru:PrDocumentDate"/></xsl:call-template> 
                                                      </xsl:if>
                                                      <xsl:if test="catWH_ru:VttCustomsCode"> Код таможни: <xsl:value-of select="catWH_ru:VttCustomsCode"/></xsl:if>
                                                      <xsl:if test="position()!=last()">;<br/></xsl:if>
                                                   </xsl:for-each>
                                                </xsl:if>
                                             </xsl:for-each>
                                             <!--xsl:value-of select="../do2r_in:Output/do2r_in:OrderCustDoc/cat_ru:PrDocumentName"/>
												<br/>
												<xsl:value-of select="../do2r_in:Output/do2r_in:OrderCustDoc/cat_ru:PrDocumentNumber"/>
												<br/>
												<xsl:call-template name="russian_date">
													<xsl:with-param name="dateIn" select="../do2r_in:Output/do2r_in:OrderCustDoc/cat_ru:PrDocumentDate"/>
												</xsl:call-template-->
                                          </td>
                                          ...
                                          <td style="width:18mm">
                                             ...
                                             <xsl:value-of select="../do2r_in:Output/do2r_in:Consignee/cat_ru:OrganizationName"/>
                                          </td>
                                          ...
                                          <td style="width:17mm">
                                             ...
                                             <xsl:value-of select="../do2r_in:Result/do2r_in:CargoPlace/catWH_ru:PlaceNumber"/>
                                          </td>
                                          ...
                                          <td style="width:17mm">
                                             ...
                                             <xsl:value-of select="../do2r_in:Result/do2r_in:BruttoVolQuant/catWH_ru:GoodsQuantity"/> 
						<xsl:value-of select="../do2r_in:Result/do2r_in:BruttoVolQuant/catWH_ru:MeasureUnitQualifierName"/> 
						<xsl:value-of select="../do2r_in:Result/do2r_in:BruttoVolQuant/catWH_ru:MeasureUnitQualifierCode"/>
                                             <br/>
                                             <xsl:value-of select="../do2r_in:Result/do2r_in:MeasureQuantity/catWH_ru:GoodsQuantity"/> 
						<xsl:value-of select="../do2r_in:Result/do2r_in:MeasureQuantity/catWH_ru:MeasureUnitQualifierName"/> 
						<xsl:value-of select="../do2r_in:Result/do2r_in:MeasureQuantity/catWH_ru:MeasureUnitQualifierCode"/>
                                          </td>
                                          ...
                                          <td style="width:18mm">
                                             ...
                                             <xsl:value-of select="../do2r_in:Result/do2r_in:Cost"/> 
						<xsl:value-of select="../do2r_in:Result/do2r_in:CurrencyCode"/>
                                          </td>
                                       </xsl:when>
                     ...
                     <xsl:when test="(do2r_in:GoodsShipment/do2r_in:MPOSign=1) or (do2r_in:GoodsShipment/do2r_in:MPOSign='t') or (do2r_in:GoodsShipment/do2r_in:MPOSign='true')">
                        <table border="1" style="width:277mm">
                           <tr>
                              <td>  </td>
                           ...
                           <tr>
                              ...
                              <td style="width:5mm">№п/п</td>
                              <!--2-->
                              <td style="width:21mm">Дата и время поме-щения на склад</td>
                              <!--3-->
                              <td style="width:13mm">Номер отчета по форме ДО1мв</td>
                              <!--4-->
                              <td style="width:14mm">Поряд-ковый номер МПО в отч-ете по форме ДО1мв</td>
                              <!--5-->
                              <td style="width:28mm">Номер МПО</td>
                              <!--6-->
                              <!--td style= "width:15mm">Код товара в соответствии с ГС или ТН ВЭД</td-->
                              <!--7-->
                              ...
                              <td style="width:7mm">Коли-чество грузовых мест</td>
                              <!--9-->
                              <td style="width:26mm">Вес МПО либо вес емкости </td>
                              <!--10-->
                              <!--td style= "width:17mm">Стоимость товара в валюте указанной в транспортных или коммерческих документах</td-->
                              <!--11-->
                              <!--td style= "width:10mm">Буквенный код валюты</td-->
                              <!--12-->
                              <td style="width:20mm">Предельный срок вре-менного хранения</td>
                              <!--13-->
                              <td style="width:20mm">Дата и время выдачи МПО со склада</td>
                              <!--14-->
                              <td style="width:7mm">Коли-чество грузовых мест</td>
                              <!--15-->
                              <td style="width:20mm">Вес МПО либо вес емкости </td>
                              <!--16-->
                              <!--td style= "width:17mm">Стоимость товара в валюте указанной в транспортных или коммерческих документах</td-->
                              <!--17-->
                              <td style="width:47mm">Вид, дата и номер документа, по которому разрешена выдача МПО со склада</td>
                              <!--18-->
                              <td style="width:38mm">Наименование получателя</td>
                              <!--19-->
                              <!--td style= "width:7mm">Коли-чество гру-зовых мест</td-->
                              <!--20-->
                              <!--td style= "width:17mm">Вес товара брутто (в кг) или объем товара (в куб.м) (либо в доп. еди-ницах из-мерения) </td-->
                           ...
                           <xsl:for-each select="do2r_in:GoodsShipment/do2r_in:Goods">
                              ...
                              <xsl:for-each select="do2r_in:Input">
                                 ...
                                 <tr>
                                    ...
                                    <!--4 Порядковый номер товаров в отчете по форме ДО1мв-->
                                    <td>
                                       <xsl:value-of select="do2r_in:DO1GoodLink/do2r_in:MPOIndexNum"/>
                                    </td>
                                    <!--5 Наименование товара-->
                                    <td>
                                    ...
                                    <!--6 Код товара в соответствии с ГС или ТН ВЭД-->
                                    <!--td>
						<xsl:value-of select="do2r_in:Input/catWH_ru:GoodsTNVEDCode"/>
					</td-->
                                    <!--7 складской номер-->
                                    <td>
                                       <xsl:value-of select="do2r_in:MPOCaseNum"/>
                                    </td>
                                    <!--8 Количество грузовых мест -->
                                    <td>1</td>
                                    <!--9  Вес товара брутто (в кг) или объем товара (в куб.м) (либо в доп. единицах измерения)-->
						...
						<xsl:value-of select="catWH_ru:MeasureQuantity/catWH_ru:MeasureUnitQualifierCode"/>
                                    ...
                                    <!--10  Стоимость товара в валюте указанной в транспортных или коммерческих документах-->
                                    <!--td>
						<xsl:value-of select="do2r_in:Input/catWH_ru:InvoiceCost"/>
					</td-->
                                    <!--11 Буквенный код валюты-->
                                    <!--td>
						<xsl:value-of select="do2r_in:Input/catWH_ru:CurrencyCode"/>
					</td-->
                                    <!--12 Дата окончания временного хранения-->
                                    <td>
                                       <xsl:call-template name="russian_date">
                                             ...
                                             <xsl:for-each select="(../../do2r_in:GoodsCustomDocsLinks)">
                                                ...
                                                <xsl:if test="(do2r_in:GoodNumber)=$Num">
                                                   <xsl:for-each select="../do2r_in:CustomsDocs[position()=$doc]">
                                                      ...
                                                      <xsl:if test="catWH_ru:VttCustomsCode"> Код таможни: <xsl:value-of select="catWH_ru:VttCustomsCode"/></xsl:if><br/>
												   </xsl:for-each>
											    </xsl:if> 
											 </xsl:for-each>  
                                          </td>
   ...
   <xsl:template name="DO2Radd">
      <tr>
         <td align="center">
            <b>Добавочный лист №</b>
            <u>
               <xsl:value-of select="do2r_in:AddedListNumber"/>
               <xsl:text> </xsl:text>
            </u>
            <b>к отчету №</b>
            <u>
                  ...
                  <table border="1" width="250mm">
                     ...
                     <xsl:for-each select="do2r_in:GoodsShipment/do2r_in:Goods">
                        <tr>
                           ...
                           <td>
                              <xsl:call-template name="russian_date">
                                 <xsl:with-param name="dateIn" select="do2r_in:Input/do2r_in:DO1GoodLink/do2r_in:DO1Date"/>
                              </xsl:call-template>
                              <br/>
                              <xsl:value-of select="do2r_in:Input/do2r_in:DO1GoodLink/do2r_in:DO1Time"/>
                           </td>
                           <!--3 Номер отчета по форме ДО1мв-->
                           <td>
                              <xsl:value-of select="do2r_in:Input/do2r_in:DO1GoodLink/do2r_in:DO1Number"/>
                           </td>
                           <!--4 Порядковый номер товаров в отчете по форме ДО1мв-->
                           <td>
                              <xsl:value-of select="do2r_in:Input/do2r_in:DO1GoodLink/do2r_in:DO1GoodNumber"/>
                           </td>
                           <!--5 Наименование товара-->
                           <td>
                              <xsl:value-of select="do2r_in:Input/catWH_ru:GoodsDescription"/>
                           </td>
                           <!--6 Код товара в соответствии с ГС или ТН ВЭД-->
                           <td>
                              <xsl:value-of select="do2r_in:Input/catWH_ru:GoodsTNVEDCode"/>
                           ...
                           <!--7 складской номер-->
                           <td>
                              <xsl:value-of select="do2r_in:Input/do2r_in:WHNumber"/>
                           </td>
                           <!--8 Количество грузовых мест -->
                           <td>
                              <xsl:value-of select="do2r_in:Input/catWH_ru:CargoPlace/catWH_ru:PlaceNumber"/>
                           </td>
                           <!--9  Вес товара брутто (в кг) или объем товара (в куб.м) (либо в доп. единицах измерения)-->
                           <td>
                              <xsl:value-of select="do2r_in:Input/catWH_ru:BruttoVolQuant/catWH_ru:GoodsQuantity"/> 
						<xsl:value-of select="do2r_in:Input/catWH_ru:BruttoVolQuant/catWH_ru:MeasureUnitQualifierName"/> 
						<xsl:value-of select="do2r_in:Input/catWH_ru:BruttoVolQuant/catWH_ru:MeasureUnitQualifierCode"/>
                              <br/>
                              <xsl:value-of select="do2r_in:Input/catWH_ru:MeasureQuantity/catWH_ru:GoodsQuantity"/> 
						<xsl:value-of select="do2r_in:Input/catWH_ru:MeasureQuantity/catWH_ru:MeasureUnitQualifierName"/> 
						<xsl:value-of select="do2r_in:Input/catWH_ru:MeasureQuantity/catWH_ru:MeasureUnitQualifierCode"/>
                           </td>
                           <!--10  Стоимость товара в валюте указанной в транспортных или коммерческих документах-->
                           <td>
                              <xsl:value-of select="do2r_in:Input/catWH_ru:InvoiceCost"/>
                           ...
                           <td>
                              <xsl:call-template name="russian_date">
                                 <xsl:with-param name="dateIn" select="do2r_in:Input/do2r_in:KeepingLimit/do2r_in:DeadLineDate"/>
                              </xsl:call-template>
                           </td>
                           <!--13 Дата и время выдачи товара со склада-->
                           <td>
                              <xsl:call-template name="russian_date">
                                 <xsl:with-param name="dateIn" select="do2r_in:Input/do2r_in:OutputDate"/>
                              </xsl:call-template>
                              <br/>
                              <xsl:value-of select="do2r_in:Input/do2r_in:OutputTime"/>
                           </td>
                           <!--14 Количество грузовых мест -->
                           <td>
                              <xsl:value-of select="do2r_in:Output/do2r_in:CargoPlace/catWH_ru:PlaceNumber"/>
					...
					<td align="center">21</td-->
                     ...
                     <xsl:for-each select="do2r_in:GoodsShipment/do2r_in:Goods">
                        <tr>
                           ...
                           <!--4 Порядковый номер товаров в отчете по форме ДО1мв-->
                           <td>
                              <xsl:value-of select="do2r_in:Input/do2r_in:DO1GoodLink/do2r_in:MPOIndexNum"/>
                           </td>
                           <!--5 Наименование товара-->
                           <td>
                              <xsl:value-of select="do2r_in:Input/catWH_ru:GoodsDescription"/>
						...
						<xsl:value-of select="do2r_in:Input/catWH_ru:GoodsTNVEDCode"/>
                           ...
                           <!--7 складской номер-->
                           <td>
                              <xsl:value-of select="do2r_in:Input/do2r_in:MPOCaseNum"/>
                           </td>
                           <!--8 Количество грузовых мест -->
                           <td>
						1
						...
						<xsl:value-of select="do2r_in:Result/do2r_in:BruttoVolQuant/catWH_ru:GoodsQuantity"/>&#160;
						<xsl:value-of select="do2r_in:Result/do2r_in:BruttoVolQuant/catWH_ru:MeasureUnitQualifierName"/>&#160;
						<xsl:value-of select="do2r_in:Result/do2r_in:BruttoVolQuant/catWH_ru:MeasureUnitQualifierCode"/><br/>
						<xsl:value-of select="do2r_in:Result/do2r_in:MeasureQuantity/catWH_ru:GoodsQuantity"/>&#160;
						<xsl:value-of select="do2r_in:Result/do2r_in:MeasureQuantity/catWH_ru:MeasureUnitQualifierName"/>&#160;
						<xsl:value-of select="do2r_in:Result/do2r_in:MeasureQuantity/catWH_ru:MeasureUnitQualifierCode"/>
					</td-->
      ...
      <table width="270mm">
         <tr>
            <td style="width:135mm">Количество добавочных листов отчета
					<xsl:value-of select="do2r_in:AddedListsCount"/>
            </td>
            <td>
               <xsl:call-template name="russian_date">
                  <xsl:with-param name="dateIn" select="catWH_ru:ReportDate"/>
   ...
   <xsl:template match="do2r_in:DO2ReportIn">
      <html>
         <head>
            <title>DO2ReportIn</title>
            ...
            <style type="text/css">
					...
					div.page { width: 297mm; /*height: 210mm;*/ margin-top: 6pt; margin-bottom: 6pt; padding:	10mm; background: #ffffff; border: solid 1pt #000000; }
					p.number-date { font-weight: bold; }
					.bordered {border: solid 1pt #000000; padding-top:4pt; padding-bottom:4pt; font-size:10pt }
					.underlined { border-bottom: solid 0.5pt #000000; }
