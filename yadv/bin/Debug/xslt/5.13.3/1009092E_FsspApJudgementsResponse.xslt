...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.13.3" xmlns:fssp_apj_res="urn:customs.ru:Information:SQDocuments:FsspApJudgementsResponse:5.13.3">
	<!-- Шаблон для типа FsspApJudgementsResponseType -->
	<xsl:template match="fssp_apj_res:FsspApJudgementsResponse">
		<html>
			<head>
				<style>
					body {
				...
				<div class="page">
						...
						<tbody>
							<tr>
								<td align="center" class="graphMain">
									<font size="4">
										<b>Ответ на предачу сведений из системы ЕАИС таможенных органов, необходимых для возбуждения исполнительного производства и исполнения судебных актов по постановлениям/решениям, исполнительным листам судов общей юрисдикции, арбитражных судов по делам об административных правонарушениях, включая конфискацию имущества</b>
									</font>
								</td>
							</tr>
						</tbody>
					...
					<table class="w190">
						<tr>
							...
							<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:ConversationId"/></td>
						</tr>
						<tr>
							<td class="annot graphMain" style="width:50%">Идентификатор ИД АИС ведомства</td>
							<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:EaisId"/></td>
						</tr>
						<tr>
							<td class="annot graphMain" style="width:50%">Дата отправки документа</td>
							<td class="value graphMain" style="width:50%">
								<xsl:call-template name="russian_date">
									<xsl:with-param name="dateIn" select="fssp_apj_res:DocumentDate"/>
								</xsl:call-template>
							</td>
						</tr>
						<xsl:if test="fssp_apj_res:Barcode">
							<tr>
								<td class="annot graphMain" style="width:50%">Штрих-код</td>
								<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:Barcode"/></td>
							</tr>
						</xsl:if>
						<tr>
							<td class="annot graphMain" style="width:50%">Исполнительный документ (ИД)</td>
							<td class="value graphMain" style="width:50%">
								<xsl:value-of select="fssp_apj_res:ExecutiveDocumentType"/>&#160;
								№ <xsl:value-of select="fssp_apj_res:ExecutiveDocumentNumber"/>&#160;
								от&#32;
								<xsl:call-template name="russian_date">
									<xsl:with-param name="dateIn" select="fssp_apj_res:ExecutiveDocumentDate"/>
								</xsl:call-template>
							</td>
						</tr>
						<tr>
							...
							<td class="graphMain value" style="width:50%">
								<xsl:for-each select="fssp_apj_res:ExecutiveDocumentCopy">
									<xsl:value-of select="."/>
						...
						<tr>
							...
							<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:CaseNumber"/></td>
						</tr>
						<tr>
							<td class="annot graphMain" style="width:50%">Дата принятия решения по делу</td>
							<td class="value graphMain" style="width:50%">
								<xsl:call-template name="russian_date">
									<xsl:with-param name="dateIn" select="fssp_apj_res:CaseDecisionDate"/>
								</xsl:call-template>
							</td>
						</tr>
						<tr>
							<td class="annot graphMain" style="width:50%">Наименование органа, выдавшего ИД</td>
							<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:ExecutiveDocumentIssuerName"/></td>
						</tr>
						<tr>
							<td class="annot graphMain" style="width:50%">Адрес органа, выдавшего ИД</td>
							<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:ExecutiveDocumentIssuerAddress"/></td>
						</tr>
						<tr>
							<td class="annot graphMain" style="width:50%">ФИО и должность подписавшего лица</td>
							<td class="value graphMain" style="width:50%"><xsl:apply-templates select="fssp_apj_res:SignPerson"/></td>
						</tr>
					</table>
					...
					<table class="w190">
						<tr>
							...
							<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:DebtorType"/></td>
						</tr>
					</table>
					<div class="marg-top2">Физическое лицо</div>
					<xsl:apply-templates select="fssp_apj_res:PrivatePerson"/>
					<div class="marg-top2">Юридическое лицо</div>
					<xsl:apply-templates select="fssp_apj_res:LegalEntity"/>
					<div class="title marg-top">Предмет исполнения</div>
					<xsl:apply-templates select="fssp_apj_res:ExecutiveObject"/>
					<div class="title marg-top">Информация о задолженности</div>
					<xsl:apply-templates select="fssp_apj_res:DebtInfo"/>
					<div class="title marg-top">Исполнительный документ</div>
					<xsl:apply-templates select="fssp_apj_res:ExecutiveDocument"/>
					<div class="title marg-top">Сведения</div>
					<xsl:apply-templates select="fssp_apj_res:Information"/>
				</div>
			</body>
		</html>
	</xsl:template>
	...
	<xsl:template match="fssp_apj_res:AddressInformation| fssp_apj_res:DebtorAddress">
	...
	<!-- Шаблон для типа fssp_apj_res:DebtInfoType -->
	<xsl:template match="fssp_apj_res:DebtInfo">
		<table class="w190">
			<tr>
				<td class="annot graphMain" style="width:50%">Сумма долга или начисления долга</td>
				<td class="value graphMain" style="width:50%"><xsl:value-of select="translate(fssp_apj_res:Sum, '.', ',')"/></td>
			</tr>
			<tr>
				<td class="annot graphMain" style="width:50%">Дата срока добровольного погашения задолженности</td>
				<td class="value graphMain" style="width:50%">
					<xsl:call-template name="russian_date">
						<xsl:with-param name="dateIn" select="fssp_apj_res:RepaymentDate"/>
					</xsl:call-template>
				</td>
			</tr>
			<tr>
				...
				<td class="value graphMain" style="width:50%">
					<xsl:choose>
						<xsl:when test="fssp_apj_res:IsDublicate='true' or fssp_apj_res:IsDublicate='1'">есть</xsl:when>
	...
	<xsl:template match="fssp_apj_res:DebtorName| fssp_apj_res:SignPerson">
		<xsl:value-of select="cat_ru:PersonSurname"/>&#160;
		<xsl:value-of select="cat_ru:PersonName"/>&#160;
		<xsl:value-of select="cat_ru:PersonMiddleName"/>
		<xsl:if test="cat_ru:PersonPost">, должность: <xsl:value-of select="cat_ru:PersonPost"/></xsl:if>
	</xsl:template>
	<!-- Шаблон для типа fssp_apj_res:ExecutiveDocumentType -->
	<xsl:template match="fssp_apj_res:ExecutiveDocument">
		<table class="w190">
			<tr>
				<td class="annot graphMain" style="width:50%">Исполнительный документ</td>
				<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:ExecutiveDocument"/></td>
			</tr>
			<tr>
				<td class="annot graphMain" style="width:50%">ЭП исполнительного документа</td>
				<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:ExecutiveDocumentSign"/></td>
			</tr>
		</table>
	</xsl:template>
	<!-- Шаблон для типа fssp_apj_res:ExecutiveObjectType -->
	<xsl:template match="fssp_apj_res:ExecutiveObject">
		<table class="w190">
			<tr>
				<td class="annot graphMain" style="width:50%">Тип предмета исполнения</td>
				<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:Type"/></td>
			</tr>
			<tr>
				<td class="annot graphMain" style="width:50%">Наименование предмета исполнения</td>
				<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:Name"/></td>
			</tr>
		</table>
	</xsl:template>
	<!-- Шаблон для типа fssp_apj_res:PrivatePersonType -->
	<xsl:template match="fssp_apj_res:IdentityCard| fssp_apj_res:PrivatePerson">
		<table class="w190">
			<tr>
				<td class="annot graphMain" style="width:50%">Ф.И.О.</td>
				<td class="value graphMain" style="width:50%"><xsl:apply-templates select="fssp_apj_res:DebtorName"/></td>
			</tr>
			<tr>
				<td class="annot graphMain" style="width:50%">Адрес по месту регистрации/пребывания</td>
				<td class="value graphMain" style="width:50%"><xsl:apply-templates select="fssp_apj_res:DebtorAddress"/></td>
			</tr>
			<tr>
				<td class="annot graphMain" style="width:50%">Дата рождения</td>
				<td class="value graphMain" style="width:50%">
					<xsl:call-template name="russian_date">
						<xsl:with-param name="dateIn" select="fssp_apj_res:BirthDate"/>
					</xsl:call-template>
					<xsl:choose>
						<xsl:when test="fssp_apj_res:TruthBirthDate='0'"> (полная точность)</xsl:when>
						<xsl:when test="fssp_apj_res:TruthBirthDate='1'"> (с точностью до месяца, число недостоверно)</xsl:when>
						<xsl:when test="fssp_apj_res:TruthBirthDate='2'"> (с точностью до года, число и месяц недостоверны)</xsl:when>
					</xsl:choose>
				</td>
			</tr>
			<xsl:if test="fssp_apj_res:BirthPlace">
				<tr>
					<td class="annot graphMain" style="width:50%">Место рождения</td>
					<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:BirthPlace"/></td>
				</tr>
			</xsl:if>
			<xsl:if test="fssp_apj_res:INN">
				<tr>
					<td class="annot graphMain" style="width:50%">ИНН</td>
					<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:INN"/></td>
				</tr>
			</xsl:if>
			<xsl:if test="fssp_apj_res:OGRNIP">
				<tr>
					<td class="annot graphMain" style="width:50%">ОГРНИП</td>
					<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:OGRNIP"/></td>
				</tr>
			</xsl:if>
			<tr>
				<td class="annot graphMain" style="width:50%">Паспортные данные</td>
				<td class="value graphMain" style="width:50%"><xsl:apply-templates select="fssp_apj_res:Passport"/></td>
			</tr>
		</table>
	</xsl:template>
	<!-- Шаблон для типа fssp_apj_res:InformationType -->
	<xsl:template match="fssp_apj_res:Information">
		<xsl:apply-templates select="fssp_apj_res:IdentityCard"/>
		<table class="w190">
			<xsl:if test="fssp_apj_res:AddressInformation">
				<tr>
					<td class="annot graphMain" style="width:50%">Адрес</td>
					<td class="value graphMain" style="width:50%"><xsl:apply-templates select="fssp_apj_res:AddressInformation"/></td>
				</tr>
			</xsl:if>
			<xsl:if test="fssp_apj_res:DebtorPhone">
				<tr>
					<td class="annot graphMain" style="width:50%">Телефон должника</td>
					<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:DebtorPhone"/></td>
				</tr>
			</xsl:if>
		</table>	
		<div class="marg-top2">Реквизиты для перечисления</div>
		<xsl:apply-templates select="fssp_apj_res:Transfer"/>
	</xsl:template>
	<!-- Шаблон для типа fssp_apj_res:LegalEntityType -->
	<xsl:template match="fssp_apj_res:LegalEntity">
		<table class="w190">
			...
			<tr>
				...
				<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:Address"/></td>
			</tr>
			<tr>
				<td class="annot graphMain" style="width:50%">Юридический адрес</td>
				<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:LegalAddress"/></td>
			</tr>
		</table>
	</xsl:template>
	<!-- Шаблон для типа RUScat_ru:RUIdentityCardType -->
	<xsl:template match="fssp_apj_res:Passport">
	...
	<!-- Шаблон для типа fssp_apj_res:TransferType -->
	<xsl:template match="fssp_apj_res:Transfer">
		<table class="w190">
			<tr>
				<td class="annot graphMain" style="width:50%">Наименование получателя</td>
				<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:ReceiverName"/></td>
			</tr>
			<tr>
				<td class="annot graphMain" style="width:50%">Банк получателя (взыскателя)</td>
				<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:BankName"/></td>
			</tr>
			<tr>
				<td class="annot graphMain" style="width:50%">БИК банка</td>
				<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:BankBIC"/></td>
			</tr>
			<tr>
				<td class="annot graphMain" style="width:50%">Расчетный счет получателя (взыскателя)</td>
				<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:ReceiverAccount"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:KPP"/></td>
			</tr>
			<tr>
				<td class="annot graphMain" style="width:50%">ОКТМО</td>
				<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:OKTMO"/></td>
			</tr>
			<tr>
				<td class="annot graphMain" style="width:50%">КБК</td>
				<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:KBK"/></td>
			</tr>
			<tr>
				<td class="annot graphMain" style="width:50%">Лицевой счет</td>
				<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:Account"/></td>
			</tr>
			<tr>
				<td class="annot graphMain" style="width:50%">Показатель типа платежа</td>
				<td class="value graphMain" style="width:50%"><xsl:value-of select="fssp_apj_res:PaymentType"/></td>
			</tr>
			<tr>
