...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:rddrd="urn:customs.ru:Information:CustomsDocuments:RequestDetailDataRD:5.10.0" xmlns:xs="http://www.w3.org/2001/XMLSchema">
	<!-- Шаблон для типа RequestDetailDataRDType -->
	<xsl:template match="rddrd:RequestDetailDataRD">
		<html>
			<head>
				...
				<div class="page">
						...
						<tbody>
							<tr>
								<td align="center" class="graphMain">
									<font size="4">
										<b>Запрос детальных данных разрешительного документа</b>
									</font>
								</td>
							</tr>
						</tbody>
					...
					<table class="w190">
						<tr>
							...
							<td class="value graphMain" style="width:50%">
								<xsl:value-of select="rddrd:BDRDID"/>
							</td>
						</tr>
					</table>
					<table class="w190">
						<tr>
							...
							<td class="value graphMain" style="width:50%">
								<xsl:value-of select="rddrd:DocumentCode"/>
							</td>
						</tr>
					</table>
				</div>
