...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:prs="urn:customs.ru:Information:CommercialFinanceDocuments:PaymentRequirements:5.13.3" xmlns:catComFin_ru="urn:customs.ru:Information:CommercialFinanceDocuments:CommercialFinanceCommonAgregateTypesCust:5.10.0" xmlns:RUDECLcat="urn:customs.ru:RUDeclCommonAggregateTypesCust:5.13.3" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.13.3" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:xs="http://www.w3.org/2001/XMLSchema">
											...
											<table width="100%">
												<tbody>
													...
													<xsl:for-each select="prs:KDTorCPCID_PMode">
														<tr align="center">
															<td class="bordered" align="center"><xsl:value-of select="position()"/></td>
															<td class="bordered" align="center"><xsl:apply-templates mode="gtd_number" select="prs:KDTID|prs:CPCID"/></td>
															<td class="bordered" align="center"><xsl:apply-templates mode="russian_date" select="prs:KDTID/cat_ru:RegistrationDate|prs:CPCID/cat_ru:RegistrationDate"/></td>
															<td class="bordered" align="center"><xsl:value-of select="prs:PaymentModeCode"/></td>
															<td class="bordered" align="right">
																<div class="cellwidener">
																<xsl:value-of select="translate(translate(format-number(prs:CompAmount, '#,###.00'),',',' '),'.',',')"/>
																</div>
								...
								<tbody>
												...
												<tbody>
													...
													<xsl:for-each select="prs:DocExcessiveAmount">
														<tr>
															...
															<td class="bordered" align="right">
																<div class="cellwidener">
																<xsl:value-of select="translate(translate(format-number(prs:ExcessiveAmount, '#,###.00'),',',' '),'.',',')"/>
																</div>
															</td>
															<td class="bordered" align="right">
																<div class="cellwidener">
									...
									<tr>
										<td>
											...
											<xsl:value-of select="translate(translate(format-number(prs:PrePaydAmount, '#,###.00'),',',' '),'.',',')"/>
	...
	<xsl:template match="prs:CustomsChief">
		<table width="100%">
			<tbody>
				<tr>
					<td width="45%">Начальник (заместитель начальника)</td>
					<td></td>
					<td width="15%"></td>
					<td></td>
					<td width="25%"></td>
				...
				<tr align="center" valign="bottom">
					<td class="value"><xsl:apply-templates select="../prs:PRSCustoms"/></td>
					<td></td>
					<td class="value"></td>
					<td></td>
					<td class="value">
			...
			<tbody>
				...
				<xsl:for-each select="prs:NoticePayment">
					<tr align="center">
						...
						<td class="bordered"><xsl:apply-templates mode="russian_date" select="cat_ru:PrDocumentDate"/></td>
