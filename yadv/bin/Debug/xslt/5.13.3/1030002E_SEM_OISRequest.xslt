...
<xsl:stylesheet version="1.0" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.12.0" xmlns:catESAD_ru="urn:customs.ru:RUCommonAggregateTypes:5.12.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:ois_req="urn:customs.ru:Information:SEMDocuments:SEM_OISRequest:5.12.0" xmlns:sem_cat="urn:customs.ru:Information:SEMDocuments:SEMCommonAggregateTypes:5.12.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
   ...
   <xsl:template match="ois_req:SEM_OISRequest">
      <html>
         <head>
            <title>Запрос по наличию объектов интеллектуальной собственности</title>
         ...
         <body>
            <div class="page">
               <h2>Запрос по наличию объектов интеллектуальной собственности</h2>
               <p class="remark">
                  <xsl:choose>
            ...
            <div class="album_page">
               ...
               <table border="1" style="table-layout:fixed;word-wrap:break-word; width:100%;">
                  ...
                  <xsl:for-each select="ois_req:Goods">
   ...
   <xsl:template match="ois_req:Goods">
      <tr>
         ...
         <td>
            ...
            <xsl:if test="../ois_req:Goods/catESAD_cu:NetWeightQuantity2 and ../ois_req:Goods/catESAD_cu:NetWeightQuantity"> / </xsl:if>
