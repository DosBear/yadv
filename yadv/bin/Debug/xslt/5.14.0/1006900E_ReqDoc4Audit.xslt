...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.14.0" xmlns:adt_cat="urn:customs.ru:Information:CustomsAuditDocuments:AuditCommonAggregateTypesCust:5.14.0" xmlns:rda="urn:customs.ru:Information:CustomsAuditDocuments:ReqDoc4Audit:5.14.0">
<!--Письмо ФТС России от 27.09.2018 № 01-54/61519 "О направлении проекта приказа ФТС России" (Приложение 17, 18, 19, 20)
...
-->
					...
					<xsl:if test="rda:IdentKindRequest='3'">
						<table>
							<tbody align="left" class="graphMain">
								...
								календарных дней с момента получения настоящего требования следующие документы и (или) сведения (копии, заверенные надлежащим образом):
							</td>
								</tr>
							</tbody>
						</table>
					...
					<table>
						<tbody align="left" class="graphMain">
							...
							<tr>
								<td>
									<xsl:choose>
										<xsl:when test="rda:IdentKindRequest = '1'">Товары должны быть представлены по адресу:</xsl:when>
							...
							<tr>
								<td class="border_bottom">
									<xsl:apply-templates select="rda:AddressSubmission"/>&#160;<xsl:choose>
										<xsl:when test="rda:IdentKindRequest = '1' or rda:IdentKindRequest = '2' or rda:IdentKindRequest = '4'">
	...
	<xsl:template match="rda:AddressSubmission">
		...
		<xsl:if test="rda:AnotherWayShare">
			<xsl:if test="cat_ru:PostalCode or cat_ru:CountryCode or cat_ru:CounryName or cat_ru:Region or cat_ru:City or cat_ru:StreetHouse or cat_ru:TerritoryCode">, </xsl:if>
			<xsl:value-of select="rda:AnotherWayShare"/>
		</xsl:if>
	</xsl:template>
