...
<xsl:stylesheet version="1.0" xmlns:dcdp="urn:customs.ru:Information:TransportDocuments:DecisionChangeDeliveryPlace:5.14.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.14.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
							...
							<div class="page">
								<table>
									<tbody class="graphMain">
										<tr align="center">
											<td class="graphHeader">Решение об изменении места доставки<br/>
												<br/>
												<br/>
											</td>
										</tr>
													...
													<tr>
														...
														<td width="25%" align="center" class="border_bottom">
															<xsl:call-template name="date_time">
																<xsl:with-param name="dateTimeIn" select="dcdp:DocumentDate"/>
										...
										<table class="normal" width="100%">
											<tbody>
												...
												<tr>
													<td class="value">
														<xsl:if test="dcdp:TransportDoc/dcdp:DTNumber">Транзитная декларация: <xsl:apply-templates select="dcdp:TransportDoc/dcdp:DTNumber"/>
															<xsl:if test="dcdp:TransportDoc/dcdp:MDPNumber or dcdp:TransportDoc/dcdp:CarnetNumber">
																<span class="normal">
																	<br/>
																</span>
															</xsl:if>
														</xsl:if>
														<xsl:if test="dcdp:TransportDoc/dcdp:MDPNumber"> Книжка МДП: <xsl:value-of select="dcdp:TransportDoc/dcdp:MDPNumber/dcdp:TIRSeries"/>
															<xsl:text> </xsl:text>
															<xsl:value-of select="dcdp:TransportDoc/dcdp:MDPNumber/dcdp:TIRID"/>
															<xsl:if test="dcdp:MDPNumber/dcdp:RegistrationDate"> от <xsl:call-template name="russian_date">
																	<xsl:with-param name="dateIn" select="dcdp:TransportDoc/dcdp:MDPNumber/dcdp:RegistrationDate"/>
																</xsl:call-template>
															</xsl:if>
														</xsl:if>
														<xsl:if test="dcdp:TransportDoc/dcdp:CarnetNumber">Карнет АТА:<xsl:value-of select="dcdp:TransportDoc/dcdp:CarnetNumber"/>
														</xsl:if>
													</td>
												</tr>
												<tr>
													<td align="center" class="graphLittle">(регистрационный номер транзитной декарации/книжки МДП/карнета АТА)</td>
												</tr>
												<tr>
													<td class="delim"><br/></td>
												</tr>
										...
										<table class="normal" width="100%">
											<tbody>
												<tr>
													<td align="left" valign="bottom" width="20%" class="normal">по Завялению</td>
													...
													<td align="left" valign="bottom" class="value" width="75%">
														<xsl:apply-templates select="dcdp:AppNumber"/>
													</td>
												</tr>
												<tr>
													<td align="left" class="graphLittle" colspan="2"></td>
													<td align="center" colspan="2" class="graphLittle">(номер Заявления на изменение места доставки)</td>
												</tr>
											</tbody>
										</table>
										<table class="normal" width="100%">
											<tbody>
												<tr>
													<xsl:if test="dcdp:CondotionChange">
														...
														<tr>
															<td align="center" class="graphLittle">(обстоятельства, обусловившие необходимость изменения места доставки)</td>
														</tr>
														<tr>
															<td class="delim"><br/></td>
														</tr>
														<tr>
															<td align="left" class="normal">
																<br/>принято решение об изменении места доставки.</td>
														</tr>
													</xsl:if>
												</tr>
											</tbody>
										...
										<table class="normal" width="100%">
											<tbody>
												<tr>
													<td align="left" valign="bottom" width="60%" class="normal">Дата завершения действия таможенной процедуры таможенного транзита:</td>
													<td align="center" valign="bottom" width="40%" class="value">
														<xsl:call-template name="date_time">
															<xsl:with-param name="dateTimeIn" select="dcdp:EndTransit"/>
															<xsl:with-param name="part" select="'1'"/>
														</xsl:call-template>
													</td>
												</tr>
						...
						<body>
							<div class="page">
								<table>
									<tbody class="graphMain">
										<tr align="center">
											<td class="graphHeader">Решение об отказе в изменении места доставки<br/>
												<br/>
												<br/>
											</td>
										</tr>
												...
												<tr>
													<tr>
														<xsl:if test="dcdp:FailureCause">
															...
															<tr>
																<td align="center" class="graphLittle">(причины отказа в изменении места доставки)</td>
															</tr>
															<tr>
																<td class="delim"><br/></td>
															</tr>
															<tr>
																<td class="normal">
																	<br/>в изменении места доставки товаров отказано.						</td>
															</tr>
														</xsl:if>
													</tr>
												</tr>
	...
	<xsl:template name="RegistrationNumber" match="dcdp:TransportDoc/dcdp:DTNumber | dcdp:AppNumber">
		<span class="normal">
