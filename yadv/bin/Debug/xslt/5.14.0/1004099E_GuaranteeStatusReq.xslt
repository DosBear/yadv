...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:gsreq="urn:customs.ru:Information:ExchangeDocuments:GuaranteeStatusReq:5.14.0">
	<xsl:output method="html" indent="yes"/>
	<xsl:template match="gsreq:GuaranteeStatusReq">
		<html>
			<head>
				<title>Запрос статуса процесса работы с дополнением к договору поручительства/ Запрос сведений о лицах, несущих солидарную ответственность / Запрос на резервирование средств при непредоставлении обеспечения</title>
									...
									<font size="4">
										<b>
											<xsl:choose>
												...
												<xsl:when test="gsreq:RequestKind=3">Запрос на резервирование средств при непредоставлении обеспечения</xsl:when>
												<xsl:when test="gsreq:RequestKind=4">Запрос на разрезервирование средств при непредоставлении обеспечения</xsl:when>
