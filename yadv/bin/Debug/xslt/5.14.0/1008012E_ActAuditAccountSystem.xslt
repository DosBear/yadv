				...
				<div class="page">
					...
					<table>
						<tbody>
							...
							<tr>
								<td align="center" class="underwrite">(должность, структурное подразделение, инициалы, фамилия)</td>
							</tr>
							<tr>
								<td class="delim"> </td>
							</tr>
							<tr>
								<td style="text-align: justify" class="graphMain">
									...
									</xsl:call-template>в соответствии с частью 6 статьи 244  Федерального закона от 3 августа 2018 г. № 289-ФЗ «О  таможенном регулировании в Российской Федерации и о внесении изменений в отдельные законодательные акты Российской Федерации» (Собрание законодательства Российской Федерации 2018, № 32, ст. 5082) проведена  проверка наличия системы учета товаров и ведения учета товаров у </td>
							</tr>
							<tr>
								<td class="delim_3"> </td>
							</tr>
							...
							<tr>
								<td align="center" class="underwrite">(наименование, ИНН*, КПП**, ОГРН*** юридического лица либо фамилия, имя, отчество (при наличии) индивидуального предпринимателя, ИНН*, ОГРНИП****, место нахождение проверяемого лица, место (места) фактического осуществления деятельности, адрес либо место жительства индивидуального предпринимателя)</td>
							</tr>
							<tr>
								<td class="delim"> </td>
							</tr>
							...
							<tr>
								<td align="center" class="underwrite">(информация, характеризующая систему учета товаров, порядок ведения учета товаров, информация о выявленных фактах нарушения  требований права ЕАЭС и законодательства Российской Федерации о таможенном регулировании со ссылками на нормативные правовые акты)</td>
							</tr>
							<tr>
								<td class="delim"> </td>
							</tr>
						...
						<tbody>
							...
							<tr>
								<td>
									...
									***ОГРН - основной государственнный регистрационный номер
									****ОГРНИП - основной государственнный регистрационный номер индивидуального предпринимателя
								</td>
							</tr>
						</tbody>
					</table>
