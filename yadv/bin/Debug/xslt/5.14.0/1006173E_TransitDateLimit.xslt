...
<xsl:stylesheet version="1.0" xmlns:tdl="urn:customs.ru:Information:CustomsDocuments:TransitDateLimit:5.14.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.14.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
				...
				<div class="page">
					<table>
						<tbody class="graphMain">
							...
							<tr align="center">
								<xsl:if test="tdl:RegistrationNumber">
									<td>
										<xsl:apply-templates select="tdl:RegistrationNumber"/>
										<br/>
										<br/>
										<br/>
									</td>
							...
							<xsl:if test="tdl:Applicant != tdl:Carrier">
								<tr>
									<td class="value">
					...
					<br/>
					<tr>
						<xsl:apply-templates select="tdl:CustomsPersonReg"/>
					</tr>
					<br/>
					<tr>
						<xsl:apply-templates select="tdl:Chief"/>
					</tr>
				</div>
			</body>
		</html>
	...
	<xsl:template match="tdl:RegistrationNumber">
	...
	<xsl:template match="tdl:CustomsPersonReg">
		<table class="normal" width="100%">
			<tbody>
				...
				<tr align="center" valign="bottom">
					<td class="value">
						<xsl:apply-templates select="../tdl:CustomsReg"/>
					</td>
					<td/>
					<td class="value"/>
					<td/>
